...
public final class agentLoginReports_jsp extends org.apache.jasper.runtime.HttpJspBase
...
pageLogData.openConnection();
      ...
      out.write("\r\n");
      out.write("<head>\r\n");
      out.write("<title>AheevaCCS - Agent Login Reports</title>\r\n");
	...
	System.out.println("fin for tabObj ");
      ...
      out.write("\t\t\t<button type=\"button\" style=\"border:none; background:none; cursor:hand;\" onClick=\"window.open('printAgentLoginReport.jsp?startingDateDaily=");
...
out.write(language); 
	...
	{	
      ...
      out.write("\r\n");
      out.write("\t\t<td width=\"25%\" align=\"center\"><a href=\"agentLoginReports.jsp?startingDateDaily=");
out.write(startingDateDaily) ;
      out.write("&endingDateDaily=");
out.write(endingDateDaily) ;
      out.write("&starting_year_yearly=");
...
out.write(language); 
      ...
      out.write(' ');
      out.write('>');
      out.print( pageLogData.getWord("Previous"));
      out.write("</a></td>\n");
      out.write("\t");
	...
	if(numCampaigns >1 && all_obj.compareTo("0") ==0)
	{
      ...
      out.write("\r\n");
      out.write("\t\t<td width=\"25%\" align=\"center\">\r\n");
      out.write("\t\t<a href=\"agentLoginReports.jsp?startingDateDaily=");
out.write(startingDateDaily) ;
      out.write("&endingDateDaily=");
out.write(endingDateDaily) ;
      out.write("&starting_year_yearly=");
...
out.write(language); 
      ...
      out.write(' ');
      out.write('>');
      out.print( pageLogData.getWord("All"));
      out.write("</a>\n");
      out.write("\t\t</td>\r\n");
      out.write("\t");
...
out.write(language); 
      ...
      out.write(' ');
      out.write('>');
      out.print( pageLogData.getWord("Next"));
      out.write("</a>\n");
      out.write("\t\t</td>\r\n");
      out.write("\t");
