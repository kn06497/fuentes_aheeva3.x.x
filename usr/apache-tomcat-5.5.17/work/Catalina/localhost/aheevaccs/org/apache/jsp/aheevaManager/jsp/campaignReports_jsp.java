...
public final class campaignReports_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/aheevaManager/jsp/campaignReportsDetails.jsp");
  }
...
beanManagerData pageCrepData = new beanManagerData();
System.out.println(session.getAttribute("USER_LANGUAGE"));
if( session.getAttribute("USER_LANGUAGE") != null )
	pageCrepData.setDefaultLanguage((String)session.getAttribute("USER_LANGUAGE"));
pageCrepData.openConnection();
    
      out.write("\n");
      out.write("\r\n");
      out.write("<head>\r\n");
      out.write("<title>AheevaCCS - Campaign Reports</title>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      aheevaManager.reports.beanCallingListReport beanCampaign = null;
      synchronized (request) {
        beanCampaign = (aheevaManager.reports.beanCallingListReport) _jspx_page_context.getAttribute("beanCampaign", PageContext.REQUEST_SCOPE);
        if (beanCampaign == null){
          beanCampaign = new aheevaManager.reports.beanCallingListReport();
          _jspx_page_context.setAttribute("beanCampaign", beanCampaign, PageContext.REQUEST_SCOPE);
        }
      }
      out.write("\r\n");
      out.write("</head>\r\n");
	...
	String c_campaign ="";
      ...
      out.write("\t\t\t<button type=\"button\" style=\"border:none; background:none; cursor:hand;\" onClick=\"window.open('printCampaignReports.jsp?startingDateDaily=");
...
out.write(campaigns) ;
 ...
 out.write(language); 
	...
	{	
      ...
      out.write("\r\n");
      out.write("\t\t<td width=\"25%\" align=\"center\"><a href=\"campaignReports.jsp?startingDateDaily=");
out.write(startingDateDaily) ;
      out.write("&endingDateDaily=");
out.write(endingDateDaily) ;
      out.write("&starting_year_yearly=");
...
out.write(language); 
      ...
      out.write(' ');
      out.write('>');
      out.print( pageCrepData.getWord("Previous"));
      out.write("</a>\t\t</td>\n");
      out.write("\t");
	...
	if(numObjects >1 && all_obj.compareTo("0") ==0)
	{
      ...
      out.write("\r\n");
      out.write("\t\t<td width=\"25%\" align=\"center\">\r\n");
      out.write("\t\t<a href=\"campaignReports.jsp?startingDateDaily=");
out.write(startingDateDaily) ;
      out.write("&endingDateDaily=");
out.write(endingDateDaily) ;
      out.write("&starting_year_yearly=");
...
out.write(language); 
      ...
      out.write(' ');
      out.write('>');
      out.print( pageCrepData.getWord("All"));
      out.write("</a>\n");
      out.write("\t\t</td>\r\n");
      out.write("\t");
...
out.write(language); 
      ...
      out.write(' ');
      out.write('>');
      out.print( pageCrepData.getWord("Next"));
      out.write("</a>\n");
      out.write("\t\t</td>\r\n");
      out.write("\t");
      ...
      out.write("<form name=\"campaignReports\">\r\n");
...
////open connection to database///////
beanManagerData pageCrepdData = new beanManagerData();
System.out.println(session.getAttribute("USER_LANGUAGE"));
if( session.getAttribute("USER_LANGUAGE") != null )
	pageCrepdData.setDefaultLanguage((String)session.getAttribute("USER_LANGUAGE"));
pageCrepdData.openConnection();
...
boolean needOneMoreTotalRow = false;
    long tNbDials=0,tNbAnswered=0, tNbNoAnswer=0,tNbAbandoned=0,
         tNbAnswerMachine=0,tNbSit=0,tNbBusy=0,tNbFax=0;
    int numCampaigns = 0;
	long  ssTotNbDials =0 , ssTotNbAnswered =0 , ssTotNbNoAnswer =0,  ssTotNbAbandoned =0,
			   ssTotNbAnswerMachine =0, ssTotNbSit =0, ssTotNbBusy =0, ssTotNbFax =0;
 ...
 out.write("["+c_campaign+"]"); 
      ...
      out.write("\t\t\t\t\t\t\t");
							...
							//out.write(reportType);
							if (reportType.compareTo("Daily")==0) {
								  out.write(pageCrepdData.getWord("Daily"));
								}
							else if (reportType.compareTo("Monthly")==0) {
								out.write(pageCrepdData.getWord("Monthly"));						
								}
							else if (reportType.compareTo("Yearly")==0) {
								out.write(pageCrepdData.getWord("Yearly"));
								}
							
							
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t");
      out.print( pageCrepdData.getWord("Campaign Reports"));
      out.write("&nbsp; ");
      out.print( pageCrepdData.getWord("for"));
      out.write(" <br><br>\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t");
      out.print( pageCrepdData.getWord("To"));
      out.write("\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.print( pageCrepdData.getWord("Time"));
      out.write("</td>\n");
      out.write("\t\t\t\t  <td width=\"10%\" align=\"center\">");
      out.print( pageCrepdData.getWord("HitRate"));
      out.write("</td>\n");
      out.write("\t\t\t\t  <td width=\"10%\" align=\"center\">");
      out.print( pageCrepdData.getWord("Dials"));
      out.write("</td>\n");
      out.write("\t\t\t\t  <td width=\"10%\" align=\"center\">");
      out.print( pageCrepdData.getWord("Answered"));
      out.write("</td>\n");
      out.write("\t\t\t\t  <td width=\"10%\" align=\"center\">");
      out.print( pageCrepdData.getWord("No answer"));
      out.write("</td>\n");
      out.write("\t\t\t\t  <td width=\"10%\" align=\"center\">");
      out.print( pageCrepdData.getWord("Abandoned"));
      out.write("</td>\n");
      out.write("\t\t\t\t  <td width=\"11%\" align=\"center\">");
      out.print( pageCrepdData.getWord("Answer machine"));
      out.write("</td>\n");
      out.write("\t\t\t\t  <td width=\"8%\" align=\"center\">");
      out.print( pageCrepdData.getWord("SIT"));
      out.write("</td>\n");
      out.write("\t\t\t\t  <td width=\"8%\"  align=\"center\">");
      out.print( pageCrepdData.getWord("Busy"));
      out.write("</td>\n");
      out.write("\t\t\t\t  <td width=\"8%\" align=\"center\">");
      out.print( pageCrepdData.getWord("Fax"));
      out.write("</td>\n");
      out.write("\t\t\t  </tr>\r\n");
      out.write("\r\n");
      out.write("\t\t");
			...
			for (int i = 0; i < beanCampaign.m_vAllDetails.size(); i++) {
				  r1 = (beanCallingListDetails)beanCampaign.m_vAllDetails.elementAt(i);
				  hitr = Double.toString(r1.HitRate);
				  index = hitr.indexOf(".");
...
out.write(Long.toString(ssTotNbFax));
      ...
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t  <td bgcolor=\"#FFECF5\" align=\"center\"> <b>");
      out.print( pageCrepdData.getWord("Total"));
      out.write("</b></font></td>\n");
      out.write("\t\t\t\t  <td bgcolor=\"#FFECF5\" align=\"center\"> <b>");
out.write(thRate);
      out.write(" </b></font></td>\r\n");
