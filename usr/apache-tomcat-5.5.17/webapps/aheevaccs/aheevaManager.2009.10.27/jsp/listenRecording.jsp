...
<p align="center">&nbsp; </p>
  ...
  <fieldset > <legend class="genericTitle"> <b> <script>document.write(MultiArray["Record listening report"][lang]);</script>   </b></legend>
<br>   
<div class="reportLook" > 
  ...
  <table border="2"  cellpadding="0" cellspacing="1" style="border-collapse:separate; border-style:dotted; border-color:#DCDAD6"  width="800" id="AutoNumber1">
    <tr class="reportsTab"> 
	  ...
	  <td  align="center"> <script>document.write(MultiArray["Type"][lang]);</script> 
      </td>
    </tr>
    <%
...
%>
    ...
    <%
  	  ...
  	  out.write("<tr ><td colspan=4 align=\"center\" height=50><b>&nbsp;  <script>document.write(MultiArray[\"Error while generating report\"][lang]);</script>.. </b></font></td></tr>");
   }
  }//end if
  else{
	  out.write("<tr ><td colspan=4 align=\"center\" height=50><b>&nbsp; <script>document.write(MultiArray[\"No records available\"][lang]);</script> </b></font></td></tr>");
  }
%>
    <tr> 
      <td colspan=6><b> 
