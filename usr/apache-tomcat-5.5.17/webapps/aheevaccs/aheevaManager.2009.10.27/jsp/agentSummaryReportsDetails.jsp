	...
	<tr>
	  <td width="100%" align="center">
			<table width="100%" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName">
			  	<td width="20%"  align="center"><script>document.write(MultiArray["Agent name"][lang])</script></td>
				<td width="8%"  align="center"><script>document.write(MultiArray["Scheduled"][lang])</script></td>
				<td width="8%"  align="center"><script>document.write(MultiArray["Actual"][lang])</script></td>
				...
				<td width="8%"  align="center"><script>document.write(MultiArray["Calls out/Calls"][lang])</script></td>
				<td width="8%"  align="center"><script>document.write(MultiArray["Calls in/Calls"][lang])</script></td>
				<td width="8%"  align="center"><script>document.write(MultiArray["Transfer"][lang])</script></td>
