						...
						<table>
							...
							<tr>
								...
								<td valign="middle" class="style1">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;<script>document.write(MultiArray["To"][lang]);</script>&nbsp;&nbsp;<input type="text" id="end_date" name="end_date" onFocus="showCalendar('',this,this,'','id_reportDate',0,10,1);this.blur()" size="15">
								</td>
							</tr>
							<tr >
								<td>
							...
							<tr >
								<td class="style1">
									<script>document.write(MultiArray["Export to"][lang]);</script>
								</td>
								<td>
							...
							<tr >
								<td class="style1">
                                  <script>document.write(MultiArray["Mail from"][lang]);</script>
								</td>
								<td>
							...
							<tr >
								<td class="style1">
                                  <script>document.write(MultiArray["Mail to"][lang]);</script>
								</td>
								<td>
							...
							<tr >
								...
								<td>
									<script>document.write("<input id=\"getCeridianData\" name=\"getCeridianData\" type=\"button\" value=\""+MultiArray["Submit"][lang]+"\" onClick=\"return validateDataToSubmit();\">")</script>
								</td>
							</tr>
						</table>
