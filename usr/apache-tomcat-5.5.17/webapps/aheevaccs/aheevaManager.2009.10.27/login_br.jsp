...
var appletObj;
	...
	if(lang_id == '0') 
		...
		document.location.href = 'login_br.jsp?login=' + document.login.username.value;
...
function submitInfo()
{
	...
	{
		alert("Caracter inválido no nome");
		document.login.username.focus();
		return false;
	}
	else if(validation(document.login.password.value) == 0)
	{
		alert("Caracter inválido na senha");
	...
	displayTmpMessage("Validando Acceso.<br>Por favor aguarde...", "#3366CC");
...
{	
	...
	{			
		displayTmpMessage("Dados Inválidos.<br>Tente novamente...", "#FF0000");
      ...
      <table width="356" height="165" border="0" align="center" cellpadding="0" cellspacing="0" style="border: 1px solid rgb(136, 136, 136);">
        ...
        <tbody>
		  ...
		  <tr valign="top"> 
              ...
              <td width="187" align="right" class="style13" style="border-bottom: 1px solid rgb(187, 187, 187); padding: 4px; background-color: rgb(255, 255, 255);"><!-- Vers&atilde;o 
                3.0.0<br> -->
          ...
          <tr>
              <td colspan="2" align="center" background="img/chain_b2.jpg" style="padding: 5px; background-color: rgb(221, 221, 221);"> 
                <table align="center" border="0" cellpadding="0" cellspacing="2" width="100%">
                  <tbody>
                    <tr> 
                      <td height="23" colspan="2" class="style6" style="padding-bottom: 5px;">Favor digitar o nome de usu&aacute;rio e a senha </td>
                    </tr>
                    <tr> 
...
<input size="20" name="username" onKeyPress="checkTheKey(event)" value="<%=user%>" type="text" class="style11">
                    ...
                    <tr> 
                      <td width="170" class="style11">Senha:</td>
                      <td>
<input size="20" name="password" value="" type="password" onFocus="this.select()" onKeyPress="checkTheKey(event)" class="style11"></td>
                ...
                <div id="more">
                  <table align="center" border="0" cellpadding="0" cellspacing="2" width="100%">
                    <tbody>
                      <tr> 
                        <td width="143" height="20" class="style11">Idioma:</td>
                        <td width="197"> 
...
<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  ...
  <tr>
    <td class="style13" height="21" background="img/tile_orange.jpg"><div align="center">&copy;
		...
		%>
        2002-<%= year %> Aheeva Technologie. Todos os direitos reservados.</div></td>
  </tr>
  <tr>
    <td height="2"><img src="img/line_gray.gif" width="100%" height="1"></td>
  </tr>
