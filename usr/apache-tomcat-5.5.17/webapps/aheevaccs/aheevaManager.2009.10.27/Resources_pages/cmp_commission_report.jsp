			...
			%>
				<tr>
					<td colspan='4' align='center'>
						<table><tr>
							<td id='cal1'><script>document.write(MultiArray["Begin"][lang]);</script>:<input type='text' name='start' onfocus="showCalendar('', this, this, '', 'cal1', 0,30, 1)" size='10' /></td>
							<td id='cal2'><script>document.write(MultiArray["End2"][lang]);</script>:<input type='text' name='end' onfocus="showCalendar('', this, this, '', 'cal2', 0,30, 1)" size='10' /></td>
						</tr></table></td>
				<tr>
					<td colspan='4' align='center'><script>document.write("<input type='submit' value='" + MultiArray["Display"][lang] + "' />");</script></td>
				</tr>
			</table>
		</fieldset>
	</div>
