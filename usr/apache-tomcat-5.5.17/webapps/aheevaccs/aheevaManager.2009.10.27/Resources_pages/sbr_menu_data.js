...
//horizStyle.onborder="1px solid #999999";
	...
	aI("text="+MultiArray["Script"][lang]+";showmenu=mm file;");
	aI("text="+MultiArray["Edit"][lang]+";showmenu=mm edit;");
	aI("text="+MultiArray["Tools"][lang]+";showmenu=mm tools;");
	aI("text="+MultiArray["Help"][lang]+";showmenu=mm help;");
	...
	{		
		...
		top="offset=2"
		margin=3
		aI("text="+MultiArray["New script"][lang]+";url=javascript:menu_new_script();image=../img/18_new.gif;");
		aI("text="+MultiArray["Open"][lang]+" ...;url=javascript:menu_new_open();image=../img/open.gif;");
		aI("text="+MultiArray["Save"][lang]+" ;url=javascript:tryToSaveScript();image=../img/save.gif;");
		aI("text="+MultiArray["Save as"][lang]+"  ...;url=javascript:menu_new_save_as();separatorsize=1");
		aI("text="+MultiArray["Delete script"][lang]+";url=javascript:deleteWholeDiagram();image=../img/deleted.gif;separatorsize=1");
		aI("text="+MultiArray["Script statistics"][lang]+";url=javascript:menu_new_props();");
		aI("text="+MultiArray["Exit"][lang]+" ;url=javascript:menu_new_exit();image=../img/18_exit.gif;");
	}
	...
	{		
		...
		aI("text="+MultiArray["Clear diagram"][lang]+";url=javascript:eraseDiagram();image=../img/18_eraser.gif;separatorsize=1");		
		aI("text="+MultiArray["Validate diagram"][lang]+" ;url=javascript:menu_validateWholeSchema();image=../img/18_freelic.gif;separatorsize=1");
		aI("text="+MultiArray["Call properties"][lang]+"...;url=javascript:showCallPropsManager();");
		aI("text="+MultiArray["Delete link"][lang]+";url=javascript:deleteArrow();image=../img/18_remove_link.gif;separatorsize=1");
		aI("text="+MultiArray["Zoom diagram"][lang]+";url=javascript:zoomIn();image=../img/18_stock_zoom_in.gif;");
		aI("text="+MultiArray["Unzoom diagram"][lang]+";url=javascript:zoomOut();image=../img/18_stock_zoom_out.gif;");
		aI("text="+MultiArray["Undo zooming"][lang]+";url=javascript:fit();image=../img/18_stock_zoom_fit.gif;separatorsize=1");	
	}	
	...
	with(milonic=new menuname("mm tools"))
	{
		style = vertStyle;
		margin=3
		aI("text="+MultiArray["Statements"][lang]+" ;showmenu=mm tools_statements;");
		aI("text="+MultiArray["Actions"][lang]+";showmenu=mm tools_actions;");
		aI("text="+MultiArray["Statistics"][lang]+";showmenu=mm tools_statistics;");
	}	
	...
	with(milonic=new menuname("mm help"))
	{
		...
		top="offset=2"
		margin=3
		aI("text="+MultiArray["User manual"][lang]+";url=javascript:popupHelp();image=../img/18_faq.gif;");			
	}
	...
	{		
		style = vertStyle;
		margin=3
		aI("text="+MultiArray["Agent pickup method"][lang]+";url=javascript:addPickMethod();image=../img/18_user_headset.gif");
		aI("text="+MultiArray["Caller priority increment"][lang]+" ;url=javascript:addPriorityInc();image=../img/call_up.gif");
		aI("text="+MultiArray["Application execute"][lang]+";url=javascript:addPbxExec();image=../img/18_pbx_exec.gif");
		//aI("text=Get DTMF;url=javascript:addGetDigit();image=../img/18_onedigit.gif");
		aI("text="+MultiArray["Get dtmf"][lang]+" ;url=javascript:addGetDigit();image=../img/18_string.gif");
		aI("text="+MultiArray["Database query"][lang]+";url=javascript:addSqlQuery();image=../img/18_product.gif");
		aI("text="+MultiArray["Custom server"][lang]+";url=javascript:addCustomServer();image=../img/18_tablecell.gif");
		aI("text="+MultiArray["End call"][lang]+";url=javascript:addCallEnding();image=../img/18_phone_end.gif");
	...
	with(milonic=new menuname("mm tools_statements"))
	{
		...
		style = vertStyle;
		margin=3
		aI("text="+MultiArray["If ... else ..."][lang]+";url=javascript:addCallCondition();image=../img/18_if_else.gif");
		aI("text="+MultiArray["Switch... case..."][lang]+";url=javascript:addSwitchCase();image=../img/18_switch_case.gif");
	}
	...
	with(milonic=new menuname("mm tools_statistics"))
	{
		...
		style = vertStyle;
		margin=3
		aI("text="+MultiArray["Counter"][lang]+";url=javascript:addCounterBox();");
		aI("text="+MultiArray["Get statistic"][lang]+";url=javascript:addGetStatistic();image=../img/tarte.gif");
	}
