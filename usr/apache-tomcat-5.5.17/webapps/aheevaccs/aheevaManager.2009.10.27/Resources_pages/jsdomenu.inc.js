function createjsDOMenu() 
{
	...
	if( userHasRight("ALLOW_MANAGER_CHANGE_AGENT_STATUS") )
	{
		...
		*/
		...
		{
			ah_MenuSetAgtStatus_logout = new menuItem(""+MultiArray["Log out"][lang]+"", "menu_AgtStatus_logout", "javascript:forceAgentStatus('LOGGED_OUT')", true);
		...
		ah_MenuSetAgtStatus_hold = new menuItem(""+MultiArray["On hold"][lang]+"", "menu_AgtStatus_hold", "javascript:forceAgentStatus('HOLD')", true);
	...
	{
		ah_MenuSeeAgtMonitoring = new menuItem(""+MultiArray["Monitoring"][lang]+" ", "menu_AgtMonitor","javascript:startLiveMonitoring()", true);
	...
	ah_MenuSetGrpStatistics = new menuItem(""+MultiArray["Statistics"][lang]+" ", "menu_GrpStatistics", "javascript:showGroupStats()");
	...
	ah_MenuSetCamStats = new menuItem(""+MultiArray["Statistics"][lang]+" ", "menu_CmpStatistics", "javascript:showCmpStats()");
