...
<%
	...
	if (request.getParameter("statisticName") != null) {
		...
		if(!(m_aht_group || m_aht_agent || m_ncr_group || m_ncr_agent || m_sph_group || m_sph_agent || m_pro_rat_group ||
			...
			error = true;
			errorMsg += "-' + MultiArray[\"You must select at least one statistic\"][lang] + '\\n";
		}	
...
<table>
	...
	<table>
		<tr>
			<td align="center"><script type='text/javascript'>document.write(MultiArray["Group"][lang]);</script>
	...
	<table>
		<tr>
			<td height=20 width=200><b><script>document.write(MultiArray["Statistics"][lang])</script>:</b>
			</td>
		...
		<TR bgcolor=#e6eff4>
			<td vAlign=top colspan="2"><script>document.write(MultiArray["Total login time"][lang])</script></td>
			<td></td>
		...
		<TR bgcolor=#e6eff4>
			<td vAlign=top colspan="2"><script>document.write(MultiArray["Average waiting time"][lang])</script></td>
		...
		<TR bgcolor=#b4cfff>
			<td vAlign=top colspan="2"><script>document.write(MultiArray["Longest waiting call"][lang])</script></td>
	...
	<table>
		<tr>
			<td><script>document.write(MultiArray["Queue"][lang])</script></td>
		...
		<tr height="25">
			<td><script>document.write(MultiArray["Broadcast period (min)"][lang])</script>&nbsp;
			</td>
		...
		<tr height="25">
			<td><script>document.write(MultiArray["Message color"][lang])</script>
			</td>
		...
		<tr height="25">
			<td><script>document.write(MultiArray["Active"][lang])</script></td>
		...
		<tr height="25">
			...
			<% if(dbid == -1){ %> document.write(" <input type='submit' id='saveButton' style='HEIGHT:25px' value='" + MultiArray["Save"][lang] + "'/>");
			<% }else{ %>
				document.write(" <input type='submit' id='updateButton' style='HEIGHT:25px' value='" + MultiArray["Update"][lang] + "'/>");
