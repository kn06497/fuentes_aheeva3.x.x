...
function setUpPotentialStartLnk(theID, theOn, theObjType, theVUID)
{
	...
	{	
		...
		window.status = MultiArray["Select the entry point of the link"][lang];
	}
}
...
function addLink()
{
 	...
 	window.status = MultiArray["Select link start point"][lang];
...
function deleteArrow()
{
	if(selectedArrowID != "" && selectedArrowID != null)
	{
		...
		alert(MultiArray["Select an arrow by double-clicking on it before"][lang]);
