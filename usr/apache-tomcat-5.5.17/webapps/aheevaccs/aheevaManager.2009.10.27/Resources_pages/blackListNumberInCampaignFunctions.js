...
function addRows()
{
	...
	{
		alert(MultiArray["The number must be numeric"][lang]);
	...
	{
		code += "<tr><td colspan = '2' width='100%' align = 'center'><b>"+MultiArray["This number cannot be reached for these campaigns"][lang]+"</b></td></tr>";
	...
	{
		code += "<tr><td colspan='2' width='100%' align = 'center'><b>"+MultiArray["This number is not assigned to any campaign"][lang]+"</b></td></tr>";
	}
	code +="</table>";
