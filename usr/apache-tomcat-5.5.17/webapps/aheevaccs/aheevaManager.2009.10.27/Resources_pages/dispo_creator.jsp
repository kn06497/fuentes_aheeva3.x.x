	...
	<div class="tab-page" id="tabGeneral">
		...
		<fieldset>
			...
			<table align="center" border="1" class="reportsTabName" style="border-collapse:collapse " bordercolor="#CCCCCC">
				<tr>
					...
					<td align="center"><strong><script>document.write(MultiArray["Edit"][lang]);</script></strong></td>
				</tr>
		<%
		if(request.getParameter("mod_id") != null){
			...
			%>
					...
					<script>document.write("<input type='submit' value='" + MultiArray["Add"][lang] + "'/>");</script>
					</td></tr>
					</table>
					</form>
		<% } 
