		...
		<td width="100%" align="center">
			<table width="90%" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName" height="15">
				...
				<td width="15%"  align="center"><script>document.write(MultiArray["Entered"][lang])</script></td>
				<td width="15%"  align="center"><script>document.write(MultiArray["Answered"][lang])</script></td>
				<td width="15%"  align="center"><script>document.write(MultiArray["Abandoned"][lang])</script></td>
				<td width="15%"  align="center"><script>document.write(MultiArray["Abandoned - time out"][lang])</script></td>
				<td width="15%"  align="center"><script>document.write(MultiArray["Abandoned - no agent"][lang])</script></td>
			  </tr>
			<%
			...
			%>
					 <tr  height="15">
						 <td width="25%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(" <script>document.write(MultiArray[\"Sub total\"][lang])</script> ");%></b></font></td>
