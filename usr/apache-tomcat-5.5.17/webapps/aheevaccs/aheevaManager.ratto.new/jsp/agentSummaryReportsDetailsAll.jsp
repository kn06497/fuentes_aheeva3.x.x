			...
			<table width="100%" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  ...
			  %>
				<td width="15%" align="center"><% 
					...
					%></td>
				<td width="15%"  align="center"><script>document.write(MultiArray["Agent name"][lang])</script></td>
				...
				<td width="7%"  align="center"><script>document.write(MultiArray["Adherence"][lang])</script></td>
				<td width="7%"  align="center"><script>document.write(MultiArray["GAP"][lang])</script></td>
				<td width="6%"  align="center"><script>document.write(MultiArray["Calls/hour"][lang])</script></td>
				<td width="7%"  align="center"><script>document.write(MultiArray["Productivity"][lang])</script></td>
				<td width="9%"  align="center"><script>document.write(MultiArray["Average handling time"][lang])</script></td>
				<td width="9%"  align="center"><script>document.write(MultiArray["Average wrap up time"][lang])</script></td>
				<td width="7%"  align="center"><script>document.write(MultiArray["Calls out/in"][lang])</script></td>
				<%
				}
				if( tabObj.length == 1)
				{
				...
				<td width="10%"  align="center"><script>document.write(MultiArray["Adherence"][lang])</script></td>
				<td width="10%"  align="center"><script>document.write(MultiArray["GAP"][lang])</script></td>
				<td width="10%"  align="center"><script>document.write(MultiArray["Calls/hour"][lang])</script></td>
				<td width="10%"  align="center"><script>document.write(MultiArray["Productivity"][lang])</script></td>
				<td width="10%"  align="center"><script>document.write(MultiArray["Average handling time"][lang])</script></td>
				<td width="10%"  align="center"><script>document.write(MultiArray["Average wrap up time"][lang])</script></td>
