...
function setColumHeadersValue()
  {
	   ...
	   myData[0][0]=MultiArray["Time"][lang]+" hh:mm";//" Time hh:mm";
	   hoverHelpData[0][0]="";
	   cells[0][0]= "";
	   personalData[0]="";
	   adherenceDetails[0]="";
    ...
    <td width="350" valign="top" ><font size=4><b><script>document.write(MultiArray["Agent"][lang])</script> 	
        <% 
			if (viewType.compareTo("Daily") ==0){
				out.write(" <script language='javascript'>document.write(MultiArray[\"Daily\"][lang]);</script>");
		   	}//out.write(viewType);
			else if (viewType.compareTo("Monthly") ==0){
				out.write(" <script language='javascript'>document.write(MultiArray[\"Monthly\"][lang]);</script>");
			}
		%>
