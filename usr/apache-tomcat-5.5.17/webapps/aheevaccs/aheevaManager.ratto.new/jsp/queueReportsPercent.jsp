				...
				<tr>
					<td  class="reportsID" width="100%" align="center">
						<b>
							...
							%>
							<script>document.write(MultiArray["Percentages for queue"][lang])</script> <br><br>
							<%
							if (reportType.compareTo("Daily") ==0){
			...
			%>
				<tr class="reportsQueueRow">
					<% if(i < beanQueue.m_AnsweredSL.size() - 1){  %>
					 ...
					 <% }else{ %>
					 	<td width="20%"  align="center" ><%out.write("&gt; "+ carac + " <script>document.write(MultiArray[\"seconds\"][lang])</script>");%></td>
					 <% } %>
