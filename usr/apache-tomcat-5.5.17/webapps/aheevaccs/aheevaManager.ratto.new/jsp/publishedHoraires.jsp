	...
	<div class="tab-page" id="tabPage3"  align="center">
	  <h2 class="tab"><script>document.write(MultiArray["Shift trade"][lang])</script> </h2>
	   <script type="text/javascript">tp1.addTabPage( document.getElementById( "tabPage3" ) ); </script>
		...
		<table border=0	 align="left" >
		   <tr>
				<td align="left" width ="115"><script>document.write(MultiArray["Choose agent"][lang])</script> 1</td>
			<td align="left">
			...
			<td >&nbsp;</td>
			<td align="left" width ="80"><script>document.write(MultiArray["Choose day"][lang])</script> </td>
			...
			<tr>
			<td align="left" width ="115"><script>document.write(MultiArray["Schedule"][lang])</script></td>
	  ...
	  <h2 class="tab"><script>document.write(MultiArray["Manual schedule"][lang])</script> </h2>
	   <script type="text/javascript">tp1.addTabPage( document.getElementById( "tabPage4" ) );</script>
		...
		<table border="1px" bordercolordark="#ffffff" ><tr>
		 ...
		 <td rowspan="5" width="150" nowrap="nowrap" ><table><tr><td bgcolor="#0066FF" width="10px"></td><td><a class="legendText"><script>document.write(MultiArray["Work manual"][lang])</script> </a></td></tr>
