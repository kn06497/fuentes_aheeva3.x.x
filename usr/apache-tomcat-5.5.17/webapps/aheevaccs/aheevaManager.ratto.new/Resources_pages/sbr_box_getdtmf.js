...
function GetDtmf()
{
	...
	this.buildHTML = function()
	{
		...
		sReturn += '<tr bgcolor="#CCCCCC"><td nowrap width="90%" style="cursor:move;" onMouseDown="dragThis(\'IDGetDtfm_'+this.uID+'\')"><b>'+MultiArray["Get"][lang]+' Dtmf #'+this.uID;
		if(DEBUG)
		...
		sReturn += '<tr><td colspan="2" class="entryTD" onClick="setUpPotentialEndLnk(\''+this.uID+'\', \'DT\', \''+this.VUID+'\')"><i>'+MultiArray["Entry point"][lang]+'</i></td></tr>';
		...
		sReturn += '<tr><td colspan="2" nowrap class="entryTD" onClick="setUpPotentialStartLnk(\''+this.uID+'\', \'OnNext\', \'DT\', \''+this.VUID+'\')"><i>'+MultiArray["Output"][lang]+'';
		if(DEBUG)
	...
	this.validate = function()
	{
		...
		{
			alert(MultiArray["Error: Missing variable name for GetDtmf #"][lang]+this.uID);
		...
		{
			alert(MultiArray["Error: Missing timeout value for GetDtmf #"][lang]+this.uID);
