...
dd.getParent = function(d_o, d_p)
{
	...
	else
	{
		...
		//while(d_p && !!(d_p = d_p.parentNode || null))
		{
			if(d_p.ddObj)
			{
...
DDObj.prototype.addChild = function(d_kd, detach, defp)
{
	...
	alert('detach='+detach+'\n'+
		  ...
		  'd_kd.name='+String(d_kd.name)+'\n'+
		  'd_kd.parent='+String(d_kd.parent)+'\n'+
		  'd_kd.parent == this='+String(d_kd.parent == this)+'\n'+
		  'd_kd == this='+String(d_kd == this)+'\n'+
		  '!d_kd.is_image='+String(!d_kd.is_image)+'\n'+
		  'd_kd.defparent='+String(d_kd.defparent)+'\n'+
		  '!defp='+String(!defp)+'\n'
		  );*/
	//if(d_kd.parent && d_kd.parent == this || d_kd == this || !d_kd.is_image && d_kd.defparent /*&& !defp*/ && defp) 
	if(d_kd.parent && d_kd.parent == this || d_kd == this || !d_kd.is_image && d_kd.defparent && defp) //Ruddy Fix...
	{
		return;
	}
...
{
	//window.status = 'Picking...'+dd.e.button;
	my_architecturePickFunc();
}
