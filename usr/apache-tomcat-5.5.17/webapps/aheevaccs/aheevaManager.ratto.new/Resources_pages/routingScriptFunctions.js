...
/****-> Si des propriétés sont ajoutés, il FAUT modifier la fonction testCallPropertyValue() du fichier actuel*/
...
function validateWholeSchema()
{
	...
	for(var j = 0; j < allroutesarr.length; j++)
	{
		...
		{
			alert(MultiArray["Error: Script with the same name already exists"][lang]);
			retrieveTmpMessage();
...
@param callSeek: le champ de textè à masquer
@param callOption: le select à créer et afficher
*/
