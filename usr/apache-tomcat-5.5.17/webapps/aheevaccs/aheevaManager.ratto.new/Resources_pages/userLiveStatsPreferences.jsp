...
function validateBeforeSubmit()
{
	...
	{
		alert(MultiArray["Select at least one type of live statistic to visualize"][lang]);
		return false;
	}
...
<form name="userPreferencesForm" id="userPreferencesForm">
  ...
  <table width="100%" border="0">
    <tr>
      <td colspan="2"><p align="center" class="tab-page"><b><%=pageData.getWord("USER LIVE STATISTICS MANAGEMENT")%> </b></p>
        <p align="center"><%=pageData.getWord("Enter your live statistics view settings")%> <br>
          <br>
          <br>
        </p>
  </td>
    ...
    <tr> 
      <td width="50%">
<div align="right" class="tab-page"><%=pageData.getWord("Refresh rate")%> </div></td>
      <td width="50%"> 
        <div align="left"><span class="tab-page"> 
          <input name="refresh_rate" type="text" id="refresh_rate"
	  value="<%=Integer.parseInt(userPreferences.elementAt(0).get("REFRESH_RATE"))/1000%>" size="5" maxlength="4">
          <%=pageData.getWord("seconds")%></span></div></td>
    </tr>
    <tr> 
      <td width="50%">
<div align="right" class="tab-page"><%=pageData.getWord("Agents")%> </div></td>
      <td width="50%"> 
        <div align="left"><span class="tab-page"> 
    ...
    <tr> 
      <td width="50%">
<div align="right" class="tab-page"><%=pageData.getWord("Agent groups")%> </div></td>
      <td width="50%"> 
        <div align="left"><span class="tab-page"> 
    ...
    <tr> 
      <td width="50%" class="tab-page">
<div align="right" class="tab-page"><%=pageData.getWord("Queues")%> </div></td>
      <td width="50%"> 
        <div align="left"><span class="tab-page"> 
    ...
    <tr> 
      <td width="50%" align="right"> 
        <div align="right" class="tab-page"><%=pageData.getWord("Campaigns")%> </div></td>
    ...
    <tr> 
      <td width="50%" align="right"> 
        <div align="right" class="tab-page"><%=pageData.getWord("Calling lists")%> </div></td>
      <td width="50%" align="left"> 
        <div align="left"><span class="tab-page"> 
    ...
    <tr> 
      <td width="50%" align="right"> 
        <div align="right" class="tab-page"><%=pageData.getWord("Performance")%> </div></td>
      <td width="50%" align="left"> 
        <div align="left"><span class="tab-page"> 
    ...
    <tr> 
      <td width="50%" align="right"> 
        <div align="right" class="tab-page"><%=pageData.getWord("Teams")%> </div></td>
      <td width="50%" align="left"> 
        <div align="left"><span class="tab-page"> 
    ...
    <tr> 
      <td width="50%" align="right"> 
        <div align="right" class="tab-page"><%=pageData.getWord("Adherence")%> </div></td>
      <td width="50%" align="left"> 
        <div align="left"><span class="tab-page"> 
    ...
    <tr> 
      <td width="50%" align="right"> 
        <div align="right" class="tab-page"><%=pageData.getWord("Line management")%></div></td>
      <td width="50%" align="left"> 
        <div align="left"><span class="tab-page"> 
