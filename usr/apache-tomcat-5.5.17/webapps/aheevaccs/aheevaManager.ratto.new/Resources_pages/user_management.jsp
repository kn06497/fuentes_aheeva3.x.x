...
<%
   ...
   System.out.println( "currentuser_assignedTenants : " + currentuser_assignedTenants );
	String tenantsDataQuery 			= "select dbid, name, state from cfg_tenant_info where dbid in "+currentuser_assignedTenants+" order by name";
	String agentGroupsDataQuery 		= "select dbid, tenant_dbid, name, state from cfg_agent_group where tenant_dbid in "+currentuser_assignedTenants+" order by name";
	String campaignsDataQuery			= "select dbid, name, tenant_dbid, state from cfg_campaign where tenant_dbid in "+currentuser_assignedTenants+" order by name";
	String callinglistDataQuery			= "select dbid, name, tenant_dbid, state from cfg_calling_list where tenant_dbid in "+currentuser_assignedTenants+" order by name";
	String routingscriptDataQuery		= "select dbid, script_name, tenant_dbid, status as state from cfg_routing_script where tenant_dbid in "+currentuser_assignedTenants+" order by script_name";
	...
	String tenantsDataQueryAssoc		= "select cfg_tenant_info.dbid as dbid, cfg_tenant_info.name as name, cfg_tenant_info.state as state from cfg_tenant_info, cfg_user_authorize_ressources where cfg_user_authorize_ressources.ressource_type = 'TENANT' and cfg_user_authorize_ressources.user_dbid = '"+this_user_dbid+"' and cfg_user_authorize_ressources.ressource_dbid = cfg_tenant_info.dbid order by cfg_tenant_info.name";
	...
	String campaignsDataQueryAssoc		= "select cfg_campaign.dbid as dbid, cfg_campaign.name as name, cfg_campaign.tenant_dbid as tenant_dbid, cfg_campaign.state as state from cfg_campaign, cfg_user_authorize_ressources where cfg_user_authorize_ressources.ressource_type = 'CAMPAIGN' and cfg_user_authorize_ressources.user_dbid = '"+this_user_dbid+"' and cfg_user_authorize_ressources.ressource_dbid = cfg_campaign.dbid order by cfg_campaign.name ";
	String callinglistDataQueryAssoc	= "select cfg_calling_list.dbid as dbid, cfg_calling_list.name as name, cfg_calling_list.tenant_dbid as tenant_dbid, cfg_calling_list.state as state from cfg_calling_list, cfg_user_authorize_ressources where cfg_user_authorize_ressources.ressource_type = 'CALLING_LIST' and cfg_user_authorize_ressources.user_dbid = '"+this_user_dbid+"' and cfg_user_authorize_ressources.ressource_dbid = cfg_calling_list.dbid order by cfg_calling_list.name";
	String routingscriptDataQueryAssoc	= "select cfg_routing_script.dbid as dbid, cfg_routing_script.script_name as script_name, cfg_routing_script.tenant_dbid as tenant_dbid, cfg_routing_script.status as state from cfg_routing_script, cfg_user_authorize_ressources where cfg_user_authorize_ressources.ressource_type = 'ROUTING_SCRIPT' and cfg_user_authorize_ressources.user_dbid = '"+this_user_dbid+"' and cfg_user_authorize_ressources.ressource_dbid = cfg_routing_script.dbid order by cfg_routing_script.script_name";
					...
					<tr>
						...
						<select multiple size="7" name="available_TENANTS" style="width:100%" onChange="changeMoveButtons('TENANTS','LEFT')">						
                          <%
                           ...
                           {
                            if( ! tenantDataResult.elementAt(i).get("state").equals("0") )
                            {
										out.write("<option value=\""+tenantDataResult.elementAt(i).get("dbid")+"\">"+tenantDataResult.elementAt(i).get("name")+"</option>");
                            } 
                            else
                            {
										out.write("<option value=\""+tenantDataResult.elementAt(i).get("dbid")+"\">"+tenantDataResult.elementAt(i).get("name")+" (Inactive)</option>");
                            }
                           }
								%>
                        </select></td>
						...
						<td>
                           ...
                           {
                            if( ! tenantDataAssocResult.elementAt(i).get("state").equals("0") )
                            {
										out.write("<option value=\""+tenantDataAssocResult.elementAt(i).get("dbid")+"\">"+tenantDataAssocResult.elementAt(i).get("name")+"</option>");
                            }
                            else
                            {
										out.write("<option value=\""+tenantDataAssocResult.elementAt(i).get("dbid")+"\">"+tenantDataAssocResult.elementAt(i).get("name")+" (Inactive)</option>");
                            }
                           }
								%>
							</select>						</td>			
				...
				<table width="100%">
					...
					<tr>
						<td>
                           ...
                           {
                            if( campaignsDataResult.elementAt(i).get("state").equals("1") )
                            {
										out.write("<option value=\""+campaignsDataResult.elementAt(i).get("dbid")+"\">"+campaignsDataResult.elementAt(i).get("name")+"</option>");
                            }
                            else
                            {
										out.write("<option value=\""+campaignsDataResult.elementAt(i).get("dbid")+"\">"+campaignsDataResult.elementAt(i).get("name")+" (Inactive)</option>");
                            }
                           }
								%>
							</select>
						...
						<td>	
                           ...
                           {
                            if( campaignsAssocDataResult.elementAt(i).get("state").equals("1") )
                            {
                            ...
                            {
										out.write("<option value=\""+campaignsAssocDataResult.elementAt(i).get("dbid")+"\">"+campaignsAssocDataResult.elementAt(i).get("name")+" (Inactive)</option>");
                            }
                           }
								%>
							</select>
				...
				<table width="100%">
					...
					<tr>
						<td>
                           ...
                           {
                            if( callinglistDataResult.elementAt(i).get("state").equals("1") )
                            {
										out.write("<option value=\""+callinglistDataResult.elementAt(i).get("dbid")+"\">"+callinglistDataResult.elementAt(i).get("name")+"</option>");
                            }
                            else
                            {
										out.write("<option value=\""+callinglistDataResult.elementAt(i).get("dbid")+"\">"+callinglistDataResult.elementAt(i).get("name")+" (Inactive)</option>");
                            }
                           }
								%>
							</select>
						...
						<td>					
                           ...
                           {
                            if( callinglistAssocDataResult.elementAt(i).get("state").equals("1") )
                            {
                            ...
                            {
										out.write("<option value=\""+callinglistAssocDataResult.elementAt(i).get("dbid")+"\">"+callinglistAssocDataResult.elementAt(i).get("name")+" (Inactive)</option>");
                            }
                           }
								%>
							</select>
				...
				<table width="100%">
					...
					<tr>
						<td>
                           ...
                           {
                            if( agentgroupDataResult.elementAt(i).get("state").equals("1") )
                            {
										out.write("<option value=\""+agentgroupDataResult.elementAt(i).get("dbid")+"\">"+agentgroupDataResult.elementAt(i).get("name")+"</option>");
                            }
                            else
                            {
										out.write("<option value=\""+agentgroupDataResult.elementAt(i).get("dbid")+"\">"+agentgroupDataResult.elementAt(i).get("name")+" (Inactive)</option>");
                            }
                           }
								%>
							</select>
				...
				<table width="100%">
					...
					<tr>
						<td>
                           ...
                           {
                            if( routingscriptsDataResult.elementAt(i).get("state").equals("1") )
                            {
                            ...
                            {
										out.write("<option value=\""+routingscriptsDataResult.elementAt(i).get("dbid")+"\">"+routingscriptsDataResult.elementAt(i).get("script_name")+" (Inactive)</option>");
                            }
                           }
								%>
							</select>
						...
						<td>
                           ...
                           {
                            if( routingscriptsAssocDataResult.elementAt(i).get("state").equals("1") )
                            {
                            ...
                            {
										out.write("<option value=\""+routingscriptsAssocDataResult.elementAt(i).get("dbid")+"\">"+routingscriptsAssocDataResult.elementAt(i).get("script_name")+" (Inactive)</option>");
                            }
                           }
								%>
							</select>
