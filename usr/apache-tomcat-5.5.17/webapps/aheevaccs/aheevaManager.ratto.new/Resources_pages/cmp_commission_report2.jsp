		...
		if(rs.getInt(1) < -31 || rs.getInt(1) > 31){
			 ...
			 %>
				<table class='main'>
					<tr>
						...
						<td><strong><script>document.write(MultiArray["Begin"][lang]);</script>:</strong><%= rs.getString(8) %></td>
						<td><strong><script>document.write(MultiArray["Until"][lang]);</script>:</strong><% if( rs.getString(2).compareTo("2001-01-01") != 0) out.print(rs.getString(2));
									else out.print("-");%></td>
						<td><strong><script>document.write(MultiArray["Type"][lang]);</script>:</strong><% if(rs.getInt(5) == 0) out.print("<script>document.write(MultiArray['Per Item'][lang]);</script>");
									else if(rs.getInt(5) == 1) out.print("<script>document.write(MultiArray['Bonus'][lang]);</script>"); %></td>
						<td><strong><script>document.write(MultiArray["Extent"][lang]);</script>:</strong><% if(rs.getInt(6) == 0) out.print("<script>document.write(MultiArray['Agent'][lang]);</script>");
														else if(rs.getInt(6) == 1) out.print("<script>document.write(MultiArray['Group'][lang]);</script>");
														else if(rs.getInt(7) == 1) out.print("<script>document.write(MultiArray['Campaign'][lang]);</script>"); %></td>
						<td><strong><script>document.write(MultiArray["Base"][lang]);</script>:</strong><% if(rs.getInt(7) == 0) out.print("<script>document.write(MultiArray['Hour'][lang]);</script>");
														else if(rs.getInt(7) == 1) out.print("<script>document.write(MultiArray['Day'][lang]);</script>");
														else if(rs.getInt(7) == 2) out.print("<script>document.write(MultiArray['Week'][lang]);</script>"); %></td>
					</tr><tr>
						<td colspan='5'>
							<table>
								<tr valign='top'>
								<% query = "SELECT COUNT(*) FROM dispo, commission_object " +
									...
									rsTmp.next();
								%>
									<th rowspan='2'><script>document.write(MultiArray['Agent ID'][lang]);</script></th>
									<th rowspan='2'><script>document.write(MultiArray['Agent Last Name'][lang]);</script></th>
									<th rowspan='2'><script>document.write(MultiArray['Agent First Name'][lang]);</script></th>
									<th rowspan='2'><script>document.write(MultiArray['Work Period'][lang]);</script></th>
									<th rowspan='2'><script>document.write(MultiArray['Work Time'][lang]);</script></th>
									<th colspan='<%= rsTmp.getInt(1) + 1 %>'><script>document.write(MultiArray['Sold Items'][lang]);</script></th>
									<th colspan='<%= rsTmp.getInt(1) + 1 %>'><script>document.write(MultiArray['Sold Ratio'][lang]);</script></th>
									<th rowspan='2'><script>document.write(MultiArray['Rule'][lang]);</script></th>
									<% if(rs.getInt(5) == 0) out.println("<th rowspan='2'><script>document.write(MultiArray['Pay per Item'][lang]);</script></th>"); %>
									<th rowspan='2'><script>document.write(MultiArray['Pay'][lang]);</script></th>
								</tr><tr>
								...
								out.println("<td><script>document.write(MultiArray['Total'][lang]);</script></td>");
								...
								<% } 
								out.println("<tr>");
								out.println("<td colspan='3'><strong><script>document.write(MultiArray['Commission Total'][lang]);</script></strong></td>");
					...
					<tr>
						...
						%>
							<td colspan='5'>
							<h3><script>document.write(MultiArray["Agents who didn't met the requirements"][lang]);</script></h3>
							<%
			...
			<%
				if(haveWeekTested && !haveWeek){
					out.print("<div class='red'><script>document.write(MultiArray['The selected dates do not cover a full week'][lang]);</script></div>");
				}
			}
		}
