		...
		<fieldset>
			...
			if (request.getParameter("cmp_id") != null){//display the sells/options page
				if(request.getParameter("cmp_id").indexOf("'") != -1 || request.getParameter("cmp_id").indexOf('"') != -1 || request.getParameter("cmp_id").length() == 0){//error in the campaign id
					...
					try{
						rs.next();
						%><script>document.write(MultiArray["Showing properties for"][lang]);</script>: <%= rs.getString(1) %> <a href="dispo_cmp_assoc.jsp">[<script>document.write(MultiArray["Switch"][lang]);</script>]</a>
						<br />
						...
						<tr>
							...
							<td><strong><script>document.write(MultiArray["Used"][lang]);</script></strong></td>
							<td align="center"><strong><script>document.write(MultiArray["Category"][lang]);</script></strong></td>
							<td align="center"><strong><script>document.write(MultiArray["Group"][lang]);</script></strong></td>
							<td align="center"><strong><script>document.write(MultiArray["Description"][lang]);</script></strong></td>
							<td align="center"><strong><script>document.write(MultiArray["Call Code Type"][lang]);</script></strong></td>
							<td align="center"><strong><script>document.write(MultiArray["Call result"][lang]);</script></strong></td>
							<td align="center"><strong><script>document.write(MultiArray["Record Status"][lang]);</script></strong></td>
						</tr>
						<%
						...
						<td colspan="9" align="center">
							...
							<input type="hidden" name="checked_id" value="<%= checked_id %>" /> <% //this hidden value increases update performances by only updating changes 
																								%>
							<script>document.write("<input type='submit' value='" + MultiArray['Update'][lang] + "'/>");</script>
				...
				if(request.getParameter("cmp2_id").indexOf("'") != -1 || request.getParameter("cmp2_id").indexOf('"') != -1 || request.getParameter("cmp2_id").length() == 0){//invalid campaign id
					...
					try{
						rs.next();
						%><script>document.write(MultiArray["Showing configuration for"][lang]);</script>: <%= rs.getString(1) %> <a href="dispo_cmp_assoc.jsp">[<script>document.write(MultiArray["Switch"][lang]);</script>]</a>
						<br />
						...
						<tr>
							...
							<td align="center"><strong><script>document.write(MultiArray["Call result"][lang]);</script></strong></td>
							<td align="center"><strong><script>document.write(MultiArray["Record Status"][lang]);</script></strong></td>
							<td align="center"><strong><script>document.write(MultiArray["Report Order"][lang]);</script></strong></td>
							<td align="center"><strong><script>document.write(MultiArray["Call Code Menu"][lang]);</script></strong></td>
						</tr>
						<%
						query = "SELECT dispo.DBID, dispo.CATEGORY, dispo.GRP, dispo.DESCRIPTION, dispo.CALL_CODE_TYPE, " +
						...
						<tr><input type="hidden" name="posted_id" value="<%= posted_id %>" /> <% //this hidden value increases update performances by only updating changes 
																		%>
							<td colspan='10' align='center'><script>document.write("<input type='submit' value='" + MultiArray['Update'][lang] + "'/>");</script></td>
						</tr>
						<table><%
					}catch(Exception e){
						out.println("SQL rs error ---" + query );
			...
			%>
				...
				<tr>
					...
					<td align="center"><strong><script>document.write(MultiArray["Description"][lang]);</script></strong></td>
					<td align="center"><strong><script>document.write(MultiArray["Choose results"][lang]);</script></strong></td>
					<td align="center"><strong><script>document.write(MultiArray["Configure results"][lang]);</script></strong></td>
				</tr>
				<%
