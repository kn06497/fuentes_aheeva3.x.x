...
function addSite()
{
	...
	obj.innerText = MultiArray["Add site"][lang]
	//alert("1");
	obj = document.getElementById('newSiteName');
	obj.innerText = MultiArray["Site Name"][lang];
	//alert("2");
	obj = document.getElementById('newSiteIntCodecName');
	obj.innerText = MultiArray["Internal Codec"][lang];
	//alert("3");
	obj = document.getElementById('newSiteExtCodecName');
	obj.innerText = MultiArray["External Codec"][lang];
	//alert("4");	
	obj = document.getElementById('newSiteProxyHost');
	obj.innerText = MultiArray["Proxy Host"][lang];
	//alert("5");
	obj = document.getElementById('newSiteProxyPort');
	obj.innerText = MultiArray["Proxy Port"][lang];
	//alert("6");
	obj = document.getElementById('newSiteSubmitBtn');
	obj.innerText = MultiArray["Submit"][lang];
...
function addRecordingServer()
{
	...
	else //show the add site dialog
	{
		...
		if( obj ) 
			obj.innerText = MultiArray["Add new recording server"][lang];
		...
		if( obj ) 
			obj.innerText = MultiArray["Internal Secure Port"][lang];
		...
		if( obj ) 
			obj.innerText = MultiArray["External Secure Port"][lang];
			
		obj = document.getElementById('addNewRecordingSrv_TomcatMountDirLbl')
		if( obj ) 
			obj.innerText = MultiArray["Tomcat Mount Dir. on Web server"][lang];
		obj = document.getElementById('addNewRecordingSrv_recordDirFullPath_local_Lbl');
		if( obj ) 
			obj.innerText = MultiArray["Recording Dir. full path(local)"][lang];//good up to here
		obj = document.getElementById('addNewRecordingSrv_recSalesDirLbl');
		if( obj ) 
			obj.innerText = MultiArray["Recording Sales Directory"][lang];
		obj = document.getElementById('addNewRecordingSrv_recNoSalesDirLbl');
		if( obj ) 
			obj.innerText = MultiArray["Recording NoSales Directory"][lang];
		obj = document.getElementById('addNewRecordingSrv_dailySynchrLbl');
		if( obj ) 
			obj.innerText = MultiArray["Daily Synchronization"][lang];
		obj = document.getElementById('addNewRecordingSrv_sendRecToLbl');
		if( obj ) 
			obj.innerText = MultiArray["Send recordings to"][lang];
		obj = document.getElementById('addNewRecordingSrv_SynchrTimeHHmmLbl');
		if( obj ) 
			obj.innerText = MultiArray["Synchronization time(HH:mm)"][lang];
		...
		if( obj ) 
			obj.innerText = MultiArray["Max. disk to use"][lang];
...
function sendCreateEncryption()
{
	...
	else
	{
		...
		for(var i = 0; i < ecryptorsArray.length; i++)
		{
			...
			{
				alert(MultiArray["Error: Encryption server"][lang] +" "+ecryptorsArray[i].SERVERNAME +" "+MultiArray["already exists"][lang]);
				document.getElementById('dlg_addnewencryption_name').focus();
				good = false;
				break;
			}
...
function sendCreateRecordingServer()
{
							   	...
							   	document.getElementById('dlg_adddlg_addnewrecorder_Path').value == '')
	{
		...
		alert(MultiArray["Specify the local directory for recordings"][lang]);
	...
	else if(document.getElementById('dlg_adddlg_addnewrecorder_activesync').checked)
	{
		...
		{
			good = false;
			alert(MultiArray["Specify the sync. time or uncheck the synchronization option"][lang]);
		...
		{
			good = false;
			alert(MultiArray["Specify the master or uncheck the synchronization option"][lang]);
	...
	if(document.getElementById('dlg_adnewrecorder_synctime').value.length > 0 )
	{
		...
		if((synctime.charAt(2) != ':') || (synctime.length != 5)){
			good = false;
			alert(MultiArray["Please, set synchronisation time in HH:mm format, 5 characters needed!"][lang]);
			if(!document.getElementById('dlg_adnewrecorder_synctime').disabled)
			  ...
			  if((!IsInteger(tmpsnctimehr)) || (!IsInteger(tmpsnctimemin))){
			  	good = false;
				alert(MultiArray["Please, invalid synchronisation time, numbers required!"][lang]);
				if(!document.getElementById('dlg_adnewrecorder_synctime').disabled)
					document.getElementById('dlg_adnewrecorder_synctime').focus();
			  }
			  else if(tmpsnctimehr>23 || tmpsnctimemin>59){
				good = false;
				alert(MultiArray["Invalid synchronisation time"][lang]);
				if(!document.getElementById('dlg_adnewrecorder_synctime').disabled)
					document.getElementById('dlg_adnewrecorder_synctime').focus();  
			  }
	   } 	
							   	...
							   	document.getElementById('dlg_addnewrecorder_tomcaturl').value == '')
	{
		...
		alert(MultiArray["Specify the URL under TOMCAT for recordings"][lang]);
	...
	if( good )
	{
		...
		for(var i = 0; i < recordersArray.length; i++)
		{
			if(recordersArray[i].SERVER_NAME == document.getElementById('dlg_addnewrecorder_name').value)	
			{
				alert(MultiArray["Error: Recording server"][lang] +" "+recordersArray[i].SERVER_NAME +" "+MultiArray["already exists"][lang]);
				document.getElementById('dlg_addnewrecorder_name').focus();
				good = false;
				break;
			}
...
{	
	...
	{		
		...
		{			
			...
			obj.innerText = MultiArray["Site Configuration"][lang];
			...
			obj.innerText = MultiArray["Delete"][lang];
...
function displayCtiServerLiveStats()
{
	...
	if( obj )
		obj.innerText = MultiArray["Cti Live Statistics"][lang];
	obj = document.getElementById('ctiLiveStatCfg');
	if( obj )
		obj.innerText = MultiArray["Configured"][lang];
	obj = document.getElementById('ctiLiveStatConn');
	if( obj )
		obj.innerText = MultiArray["Connected"][lang];
	obj = document.getElementById('ctiLiveStatMngLbl');
	if( obj )
		obj.innerText = MultiArray["Managers"][lang];
	obj = document.getElementById('ctiLiveStatAgtLbl');
	if( obj )
		obj.innerText = MultiArray["Agent"][lang];
	obj = document.getElementById('ctiLiveStatSwitchLbl');
	if( obj )
		obj.innerText = MultiArray["Switch"][lang];
 	obj = document.getElementById('ctiLiveStatRcdrSvrLbl');
	if( obj )
		obj.innerText = MultiArray["Recording servers"][lang];
	obj = document.getElementById('ctiLiveStatEncrSvrLbl');
	if( obj )
		obj.innerText = MultiArray["Encryption servers"][lang];
...
function displaySwitchCfg(sid)
{
	for(var i = 0; i < switchesArray.length; i++)
	{
		if(switchesArray[i].unid == sid)
		{
			...
			if( obj )
				obj.innerText = MultiArray["Modify Switch"][lang];
			...
			if( obj )
				obj.innerText = MultiArray["Iax External Port"][lang];				
			...
			if( obj )
				obj.innerText = MultiArray["Update"][lang];
	...
	for(var i = 0; i < 	switchesArray.length; i++)
	{
		...
		{			
			...
			if( obj )
			{
				...
				obj.innerText = MultiArray[s][lang]; 
			}
			...
			if( obj && obj2 ) 
			{
				if( liveStatsArray[switchesArray[i].SWITCH_NAME] )
				{
					...
					obj.innerText = MultiArray["Used. "][lang] +linesUsed;//'Used. '+linesUsed;
					obj2.innerText 	= MultiArray["Total. "][lang]+linesTotal;//'Total. '+linesTotal;
...
function displayEncryptServerCfg(eid)
{
	...
	{		
		if(ecryptorsArray[i].unid == eid)
		{
			...
			if( obj ) 
				obj.innerText = MultiArray["Modify encryption server"][lang];
...
{	
	...
	{		
		if(recordersArray[i].unid == rid)
		{
			...
			if( obj ) 
				obj.innerText = MultiArray["Modify recording server"][lang];
			...
			if( obj ) 
				obj.innerText = MultiArray["Recording Dir. absolute path(local)"][lang];
			...
			if( obj ) 
				obj.innerText = MultiArray["Modify"][lang];
...
function displayRecordServerLiveStats(servname)
{
	for(var i = 0; i < recordersArray.length; i++)
	{
		if( recordersArray[i].SERVER_NAME == servname )
		{
			...
			if( obj ) 
				obj.innerText = MultiArray["Recording Server Statistics"][lang];
			...
			if( obj )
				obj.innerText = MultiArray["Total recordings"][lang];
			obj = document.getElementById('recorderSvr_dailyTotalRecordingsLbl');
			if( obj ) 
				obj.innerText = MultiArray["Daily Total recordings"][lang];	
			obj = document.getElementById('recorderSvr_diskUsageLbl');
			if( obj ) 
				obj.innerText = MultiArray["Disk usage"][lang];	
			...
			if( obj && obj2 ) 
			{
				if( liveStatsArray[recordersArray[i].SERVER_NAME] )
				{
					...
					obj.innerText 	= MultiArray["Used. "][lang]+diskUsed+' '+MultiArray["GB"][lang];// 'Used. '+diskUsed+' Go';
					obj2.innerText 	= MultiArray["Rem. "][lang]+diskRem+' '+MultiArray["GB"][lang];//'Rem. '+diskRem+' Go';
				...
				if( obj )
				{
					if( obj.innerText.indexOf(switch_name) == 0 )
					{
						...
						if( obj )
						{
							...
							obj.innerText = MultiArray[s][lang]; //obj.innerText = s;
						}
						obj = document.getElementById('dlg_switch_stats_statussince');
						if( obj )
						...
						if( obj && obj2 ) 
						{
							if( liveStatsArray[switch_name] )
							{
								...
								if(cur_switch)
								{
									...
									var linesRem = linesTotal - linesUsed;
									obj.innerText 	= MultiArray["Used. "][lang]+linesUsed;//obj.innerText 	= 'Used. '+linesUsed;good up to here
									obj2.innerText 	= MultiArray["Total. "][lang]+linesTotal;//obj2.innerText 	= 'Total. '+linesTotal;
									var obj3 = document.getElementById('dlg_switch_stats_used_lines_slide');
									var obj4 = document.getElementById('dlg_switch_stats_rem_lines_slide');
									var slide_width;
									if( obj3 )
			...
			if( obj )
			{
				...
				{			
					...
					if( obj ) 
					{
						...
						obj.innerText = MultiArray[s][lang]; //s;
					}
...
function buildReadableDatetime( timestamp )
{
	...
	rstr = MultiArray[month[thatDay.getMonth()]][lang];//rstr = month[thatDay.getMonth()];
	rstr += ',';
