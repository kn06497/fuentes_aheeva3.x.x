...
%>
	...
	<div class="tab-page" id="tab2">
		<h2 class="tab"><script>document.write(MultiArray["Category"][lang]);</script></h2>
		<script type="text/javascript">tp1.addTabPage( document.getElementById( "tab2" ) );</script>
		<fieldset>
			<legend><script>document.write(MultiArray["Add a category"][lang]);</script></legend>
		...
		%>
			...
			<tr>
				...
				<td></td>
				<td align="center"><script>document.write("<input type='submit' value='" + MultiArray["Add"][lang] + "'/>");</script></td>
			</tr>
			</table>
			</form>
		</fieldset>
	...
	<div class="tab-page" id="tab3">
		<h2 class="tab"><script>document.write(MultiArray["Group"][lang]);</script></h2>
		<script type="text/javascript">tp1.addTabPage( document.getElementById( "tab3" ) );</script>
		<fieldset>
			<legend><script>document.write(MultiArray["Add a group"][lang]);</script></legend>
	...
	<div class="tab-page" id="tab5">
		<h2 class="tab"><script>document.write(MultiArray["Call result"][lang]);</script></h2>
		<script type="text/javascript">tp1.addTabPage( document.getElementById( "tab5" ) );</script>
		<fieldset>
			<legend><script>document.write(MultiArray["Add a Call Result"][lang]);</script></legend>
			<form method="post" name="new_group">
			<table align="center" border="1" class="reportsTabName" style="border-collapse:collapse " bordercolor="#CCCCCC">
			<tr>
				<td></td>
	...
	<div class="tab-page" id="tab6">
		<h2 class="tab"><script>document.write(MultiArray["Record Status"][lang]);</script></h2>
		<script type="text/javascript">tp1.addTabPage( document.getElementById( "tab6" ), "javascript:showArticleTab( \"tab6\" )");</script>
		<fieldset>
			<legend><script>document.write(MultiArray["Add a Record Status"][lang]);</script></legend>
			<form method="post" name="new_group">
			<table align="center" border="1" class="reportsTabName" style="border-collapse:collapse " bordercolor="#CCCCCC">
			<tr>
				<td></td>
	...
	<div class="tab-page" id="tab7">
		<h2 class="tab"><script>document.write(MultiArray["Call Code Type"][lang]);</script></h2>
		<script type="text/javascript">tp1.addTabPage( document.getElementById( "tab7" ), "javascript:showArticleTab( \"tab7\" )");</script>
		<fieldset>
			<legend><script>document.write(MultiArray["Add a Call Code Type"][lang]);</script></legend>
			<form method="post" name="new_group">
			<table align="center" border="1" class="reportsTabName" style="border-collapse:collapse " bordercolor="#CCCCCC">
			<tr>
				<td></td>
