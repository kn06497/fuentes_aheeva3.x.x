...
<tr height="26">
  	<td>
	<input id="period_yealy" name="period" type="radio" value="yearly" onClick="changeDisabled()">
	<label for="period_yealy"><%=pageData.getWord("for each year")%></label>   </td>
  ...
  <tr>
   <td>
   	<input id="period_monthly" name="period" type="radio" value="monthly" onClick="changeDisabled()">
	<label for="period_monthly"><%=pageData.getWord("for each month")%></label>   </td>
   <td align="center" valign="top">
   ...
   <tr>
   <td>
    <input id="period_daily" name="period" type="radio" value="daily"  onClick="changeDisabled()" checked>
	<label for="period_daily"><%=pageData.getWord("for each day")%></label>   </td>
