					...
					'<table class="dlgTable"  cellpadding="0" cellspacing="0">'+
					 ...
					 '<tr><td colspan="2" class="dialoginsidetxt">'+
						...
						// ', $TOMCAT_DIR/webapps/aheevaccs/</td><td class="smallText"><input id="dlg_addnewrecorder_tomcaturl" type="text" value="mnt/" class="inputsmall" style="text-align:center;"></td></tr>'+
						 ...
						 '</td><td class="smallText"><input id="dlg_adddlg_addnewrecorder_salesPath" type="text" value="/usr/apache-tomcat-5.5.17/webapps/aheevaccs/recordingssales/" class="inputsmall" style="text-align:center;" disabled></td></tr>'+
						 '<tr><td class="smallText" id="addNewRecordingSrv_recNoSalesDirLbl" nowrap="nowrap">'+
						 //Recording NoSales Directory'
						 '</td><td class="smallText"><input id="dlg_adddlg_addnewrecorder_nosalesPath" type="text" class="inputsmall" value="/usr/apache-tomcat-5.5.17/webapps/aheevaccs/recordingsnosales/" style="text-align:center" disabled></td></tr>'+
					...
					'<table class="dlgTable"  cellpadding="0" cellspacing="0">'+
					 ...
					 '<tr><td colspan="2" class="dialoginsidetxt">'+
						...
						// Password
						 ...
						 '</td><td class="smallText"><input id="dlg_adddlg_addnewrecorder_Path" type="text" value="/usr/apache-tomcat-5.5.17/webapps/aheevaccs/recodings" class="inputsmall" style="text-align:center;" onchange="fillsalesnosalesbox()"></td></tr>'+
						 '<tr><td class="smallText" id="modifyRecSvr_recSalesDirLbl" nowrap="nowrap">'+
						 //Recording Sales Directory
						 '</td><td class="smallText"><input id="dlg_adddlg_addnewrecorder_salesPath" type="text" value="/usr/apache-tomcat-5.5.17/webapps/aheevaccs/recodingssales/" class="inputsmall" style="text-align:center;" disabled></td></tr>'+
						 '<tr><td class="smallText" id="modifyRecSvr_recNoSalesDirLbl" nowrap="nowrap">'+
						 //Recording NoSales Directory
						 '</td><td class="smallText"><input id="dlg_adddlg_addnewrecorder_nosalesPath" type="text" class="inputsmall" value="/usr/apache-tomcat-5.5.17/webapps/aheevaccs/recodingsnosales/" style="text-align:center" disabled></td></tr>'+
