...
function leftClickHandler(e) { // Private method
  ...
  //Added by Ruddy G.
  if(typeof(my_leftclickhandler) == "function")  
  {
	  my_leftclickhandler();
  }//~~Added by Ruddy G.
...
{ // Private method
  ...
  //Added by Ruddy G.
  if(typeof(my_rightclickhandler) == "function")  
  {
	  my_rightclickhandler();
  }//~~Added by Ruddy G.
...
function scrollHandler() { // Private method
  ...
  //Added by Ruddy G.
  if(typeof(my_scrollclickhandler) == "function")  
  {
	  my_scrollclickhandler();
  }//~~Added by Ruddy G.
