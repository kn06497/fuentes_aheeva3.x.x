        ...
        <form action="" method="" name="login" id="login">
          <tbody>
            <tr valign="top"> 
              ...
              <td width="358" align="right" class="style13" style="border-bottom: 1px solid rgb(187, 187, 187); padding: 4px; background-color: rgb(255, 255, 255);"><!-- Version
                3.0.0<br> -->
                <img src="img/white_spacer.gif" width="170" height="2"> </td>
            </tr>
            <tr> 
              <td height="121" colspan="2" align="center" background="img/chain_b2.jpg" style="padding: 5px; background-color: rgb(221, 221, 221);"> 
