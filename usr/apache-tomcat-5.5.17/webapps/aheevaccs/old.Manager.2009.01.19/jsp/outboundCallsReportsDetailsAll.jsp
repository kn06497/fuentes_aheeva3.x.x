				...
				<tr>
					<td width="100%" align="center" ><font color="#003366">
						<b>
							...
							<script>document.write(MultiArray["Outbound calls"][lang])</script>&nbsp; <script>document.write(MultiArray["Report"][lang])</script>&nbsp; <script>document.write(MultiArray["From"][lang])</script><br><br>
							<%
							if (reportType.compareTo("Daily") ==0){
		...
		<td width="100%" align="center">
			<table width="80%" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName" >
				<td width="12%" align="center"> <b><script>document.write(MultiArray["Agent ID"][lang])</script></b> </td>
				<td width="25%" align="center"> <b><script>document.write(MultiArray["Agent name"][lang])</script></b> </td>
				<td width="15%" align="center"> <b><script>document.write(MultiArray["Campaign"][lang])</script> </b> </td>
				<td width="12%" align="center"> <b><script>document.write(MultiArray["Total login time"][lang])</script></b> </td>
				<td width="10%" align="center"> <b><script>document.write(MultiArray["Total calls"][lang])</script> </b> </td>
				<td width="10%" align="center"> <b><script>document.write(MultiArray["Total contacts"][lang])</script> </b> </td>
				<td width="10%" align="center"> <b><script>document.write(MultiArray["Success"][lang])</script></b> </td>
				<td width="10%" align="center"> <b><script>document.write(MultiArray["Refusals"][lang])</script></b> </td>
				<td width="13%"   align="center"> <b> <script>document.write(MultiArray["Callbacks"][lang])</script></b> </td>
			  </tr>
<!-- traverse the array -->
			<%
			...
			<table width="80%" align="center">
				...
				<tr>
					<td width="100%" align="left">
						<b>
							<%
								out.write("<script>document.write(MultiArray[\"Statistics\"][lang])</script>");
	  ...
	  <td width="100%" align="center">
			<table width="80%" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName" >
				<td width="12%" align="center"> <b><script>document.write(MultiArray["Agent ID"][lang])</script></b> </td>
				<td width="25%" align="center"> <b><script>document.write(MultiArray["Agent name"][lang])</script></b> </td>
				<td width="16%" align="center"> <b><script>document.write(MultiArray["Campaign"][lang])</script> </b> </td>
				<td width="10%" align="center"> <b><script>document.write(MultiArray["Calls/hour"][lang])</script></b> </td>
				<td width="10%" align="center"> <b><script>document.write(MultiArray["Contact/hour"][lang])</script></b> </td>
				<td width="10%" align="center"> <b><script>document.write(MultiArray["Sales/hour"][lang])</script></b> </td>
				<td width="10%" align="center"> <b><script>document.write(MultiArray["Refusals/hour"][lang])</script></b> </td>
				<td width="13%"   align="center"> <b> <script>document.write(MultiArray["Net Conv. Rate"][lang])</script></b> </td>
			  </tr>
			<%
					  for (j = 0; j < beanAgentPerf.m_vAllDetails.size(); j++)
					   {
