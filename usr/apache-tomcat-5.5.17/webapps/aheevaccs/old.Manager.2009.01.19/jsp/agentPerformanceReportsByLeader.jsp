...
<jsp:useBean id="beanAgentPerfByLead" scope="request" class="Manager.reports.beanAgentPerfByLeadReport" />
<body>
<%
...
%>
<p align="center"><font size=4><b><script>document.write(MultiArray["Agent performance report"][lang])</script>&nbsp; <script>document.write(MultiArray["grouped by team leader"][lang])</script>
         </b></font><br><br></p>
...
<table width="400" border="0" align="center">
  <tr>
    <td   class="reportsID">
		<div align="center"><b>
        <%out.write(reportType);%> <script>document.write(MultiArray["Agent performance report"][lang])</script>&nbsp; <script>document.write(MultiArray["grouped by team leader"][lang])</script>
        <%out.write(teamLeaderName);%> <script>document.write(MultiArray["From"][lang])</script>:
        <%
		if (reportType.compareTo("Daily") ==0){
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111"  id="AutoNumber1" width="1500">
  <tr class="reportsTab">
    <td  align="center"><b><script>document.write(MultiArray["Agent name"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Scheduled"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Actual"][lang])</script></b></td>
    <td width="100"  align="center"><b>%&nbsp;<script>document.write(MultiArray["Adherence"][lang])</script></b></td>
    <td width="100"  align="center"><b>%&nbsp;<script>document.write(MultiArray["GAP"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Calls/hour"][lang])</script></b></td>
	<td width="100"  align="center"><b>%&nbsp;<script>document.write(MultiArray["Productivity"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Average handling time"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Average wrap up time"][lang])</script></b></td>
    <td width="100"  align="center"><b>%&nbsp;<script>document.write(MultiArray["Idle time"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Total"][lang])</script>&nbsp;<script>document.write(MultiArray["Idle time"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Total"][lang])</script>&nbsp;<script>document.write(MultiArray["Inbound calls"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Average inbound talk time"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Total"][lang])</script>&nbsp;<script>document.write(MultiArray["Outbound calls"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Average outbound talk time"][lang])</script></b></td>
    <td width="100"  align="center"><b>%&nbsp;<script>document.write(MultiArray["calls outbound/inbound"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Total calls transfered"][lang])</script></b></td>
    <td width="100"  align="center"><b><script>document.write(MultiArray["Average talk time transfer"][lang])</script></b></td>
    <td width="100"  align="center"><b>%&nbsp;<script>document.write(MultiArray["calls transfered Inbound"][lang])</script></b></td>
  </tr>
...
<!--Totaux-->
	<tr bgcolor="#FDFDE0" >
		<td align="left" nowrap><b><script>document.write(MultiArray["Total"][lang])</script></b></td>
...
<%
			...
			out.write("<p><font size=2>  <script language='javascript'>document.write(MultiArray[\"Error in queries..Please check the database\"][lang]);</script></font></p>");
	 }else{
			out.write("<p><font size=2>  <script language='javascript'>document.write(MultiArray[\"Error while generating Agent Performance Report\"][lang]);</script></font></p>");
	 }
	}//end try
	catch( Exception e){
		out.write("<p><font size=2>  <script language='javascript'>document.write(MultiArray[\"Error while getting data..Please check the database\"][lang]);</script></font></p>");
	}// end catch
