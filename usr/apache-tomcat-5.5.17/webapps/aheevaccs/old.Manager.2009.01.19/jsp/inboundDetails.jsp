				...
				<tr>
					<td width="100%" align="center" ><font color="#003366">
						<b>
							...
							%>
							<script>document.write(MultiArray["Inbound calls report"][lang])</script>  <br><br><script>document.write(MultiArray["From"][lang])</script>
							<%
							if (reportType.compareTo("Daily") ==0){
							...
							<%
							 ...
							 {
							 	out.write("15 min <script>document.write(MultiArray[\"Spacing(mn)\"][lang])</script>");
							 }
							 if(spacing.compareTo("30")==0)
							 {
							 	out.write("30 min <script>document.write(MultiArray[\"Spacing(mn)\"][lang])</script>");
							 }
							 if(spacing.compareTo("60")==0)
							 {
							 	out.write("60 min <script>document.write(MultiArray[\"Spacing(mn)\"][lang])</script>");
							 }
							%>
						</b></font>
					</td>
		...
		<td width="100%" align="center">
			<table width="100%" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName" >
				  <td width="20%" align="center"><b><script>document.write(MultiArray["Call date"][lang])</script></b></font></td>
				  <td width="20%"  align="center"><b><script>document.write(MultiArray["Time period"][lang])</script></b></font></td>
				  <td width="10%" align="center"><b><script>document.write(MultiArray["Entered"][lang])</script></b></font></td>
				  <td width="10%"  align="center"><b><script>document.write(MultiArray["Answered"][lang])</script></b></font></td>
				  <td width="10%"  align="center"><b><script>document.write(MultiArray["Service factor"][lang])</script></b></font></td>
				  <td width="10%"  align="center"><b><script>document.write(MultiArray["Talk time"][lang])</script></b></font></td>
				  <td width="10%"  align="center"><b><script>document.write(MultiArray["Wrap up time"][lang])</script></b></font></td>
				  <td width="10%"  align="center"><b><script>document.write(MultiArray["Hold time"][lang])</script></b></font></td>
				  <td width="10%"  align="center"><b><script>document.write(MultiArray["Average answering time"][lang])</script></b></font></td>
			  </tr>
<!-- traverse the array -->
<%
/*
			...
			{ 
			  ...
			  if (sstLoginTime == 0){
				...
				if (ssAnswered == 0) {
				  ...
				  ssavg_ans= r1.buildReadableTime( (sstTalkTime + sstWrapUp + sstHold) / ssAnswered);
				}				
		%>
				 <tr>
					 ...
					 <td bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(ssAnswered));%></b></font></td>
...
%>
			  <tr <% if(j%2 == 0) out.write("class=reportsRowPair");
			    ...
			    <td align="center"><%out.write(r1.period_min+"-"+r1.period_max);%> </td>
				  ...
				  <td align="center"><%out.write(Long.toString(r1.distibuted));%> </td>
...
<%
	...
	%>
				 <tr>
					 ...
					 <td bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(answered));%></b></font></td>
