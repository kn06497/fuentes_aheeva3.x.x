...
function submitInfo()
{
	...
	displayTmpMessage("Validation de l’accès.<br>Veuillez attendre...", "#3366CC");
...
{	
	...
	{			
		displayTmpMessage("Information Invalide.<br>Ressayer a nouveau...", "#FF0000");
...
<table width="100%" height="220" border="0" align="center">
  <tr align="left">
    ...
    <td>
      <table width="316" height="173" border="0" align="center" cellpadding="0" cellspacing="0" style="border: 1px solid rgb(136, 136, 136);">
        <form action="" method="" name="login" id="login">
          <tbody>
            <tr valign="top"> 
              <td width="158" height="42" align="right" class="style2" style="border-bottom: 1px solid rgb(187, 187, 187); padding: 4px; background-color: rgb(255, 255, 255);"> 
                <div align="left">Aheeva CCS<br>
                  <img src="img/white_spacer.gif" width="170" height="2">
                </div></td> 
              <td width="358" align="right" class="style1" style="border-bottom: 1px solid rgb(187, 187, 187); padding: 4px; background-color: rgb(255, 255, 255);">Version 
                2.2.0<br>
                <img src="img/white_spacer.gif" width="170" height="2"> </td>
            </tr>
            <tr> 
              <td height="121" colspan="2" align="center" background="img/chain_bg.jpg" style="padding: 5px; background-color: rgb(221, 221, 221);"> 
                <table align="center" border="0" cellpadding="0" cellspacing="2" width="102%">
                  <tbody>
                    <tr> 
                      <td height="23" colspan="2" class="style6" style="padding-bottom: 5px;">Veuillez 
                        saisir votre nom d’utilisateur et votre mot de passe:</td>
                    </tr>
                    <tr> 
                      <td class="style11" width="170">Nom d'utilisateur:</td>
<% String user = "";
   if(request.getParameter("login") != null)
     user = request.getParameter("login");
%>

                      <td width="229"><input size="20" name="username" onKeyPress="checkTheKey(event)" value="<%=user%>" type="text" class="style11"></td>
                    </tr>
                    <tr> 
                      <td width="170" class="style11">Mot de passe:</td>
                      <td width="229"><input size="20" name="password" value="" type="password" onFocus="this.select()" onKeyPress="checkTheKey(event)" class="style11"></td>
                    </tr>
                    <tr> 
                      <td width="170">&nbsp;</td>
                ...
                <div id="more"> 
                  <table align="center" border="0" cellpadding="0" cellspacing="2" width="100%">
                    <tbody>
                      <tr> 
                        <td width="170" height="20" class="style11">Langue:</td>
                        <td width="230"> <select onChange="SetCookie('animal', this.value, exp);language_changed(this.options[this.selectedIndex].value)" id="login_language" name="login_language" class="style12">
...
<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  ...
  <tr>
    <td class="style13" height="21" background="img/tile_blue.jpg"><div align="center">&copy; 
		...
		%>
        2002-<%= year %> Aheeva Technologie. Tous droits réservés. </div></td>
  </tr>
  <tr>
    <td height="2"><img src="img/line_gray.gif" width="100%" height="1"></td>
  </tr>
