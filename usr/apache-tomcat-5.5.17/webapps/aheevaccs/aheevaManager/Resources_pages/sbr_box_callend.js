...
function CallEnding()
{
	...
	{			
		...
		sReturn += '<tr bgcolor="#F5CDA0"><td nowrap width="90%" style="cursor:move;" onMouseDown="dragThis(\'IDCallEnding_'+this.uID+'\')"><b>'+callEnd[0]+' #'+this.uID;
		if(DEBUG)
		...
		sReturn += '<tr><td colspan="2" class="entryTD" onClick="setUpPotentialEndLnk(\''+this.uID+'\', \'CE\', \''+this.VUID+'\')"><i>'+callEnd[1]+'</i></td></tr>';
