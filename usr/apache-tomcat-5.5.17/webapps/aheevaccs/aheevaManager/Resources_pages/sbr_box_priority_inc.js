...
function PriorityInc()
	{
		...
		this.buildHTML = function()
		{
			...
			sReturn += '<tr bgcolor="#DCEBC7"><td nowrap width="90%" style="cursor:move;" onMouseDown="dragThis(\'IDPriority_'+this.uID+'\')"><b>'+prio[0]+' #'+this.uID;
			if(DEBUG)
			...
			sReturn += '<tr><td colspan="2" class="entryTD" onClick="setUpPotentialEndLnk(\''+this.uID+'\', \'PI\', \''+this.VUID+'\')"><i>'+prio[1]+'</i></td></tr>';
			...
			sReturn += '<tr><td colspan="2" class="entryTD" onClick="setUpPotentialStartLnk(\''+this.uID+'\', \'OnNext\', \'PI\', \''+this.VUID+'\')"><i>'+prio[2]+'</i></td></tr>';
			sReturn += '</table>';
			sReturn += '</div>';
