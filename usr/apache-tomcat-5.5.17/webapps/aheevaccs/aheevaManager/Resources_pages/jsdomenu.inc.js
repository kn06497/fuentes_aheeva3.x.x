function createjsDOMenu() 
{
	...
	/**** AGENTS ****/
	/* Main Menu */
	ah_AgtMenuObj 	= new jsDOMenu(200);
	...
	{
		ah_MenuSetAgtStatus = new menuItem(""+DoMenu[5]+" ", "menu_AgtStatus");
		ah_MenuSetAgtStatus_1 = new jsDOMenu(160);		
		/**** For future use ****** Thank you. Nhi ;) ************************
		...
		*/
		...
		{
			ah_MenuSetAgtStatus_logout = new menuItem(""+DoMenu[0]+"", "menu_AgtStatus_logout", "javascript:forceAgentStatus('LOGGED_OUT')", true);
		...
		// Force agent's status to HOLD 
		ah_MenuSetAgtStatus_hold = new menuItem(""+DoMenu[1]+"", "menu_AgtStatus_hold", "javascript:forceAgentStatus('HOLD')", true);
		ah_MenuSetAgtStatus_1.addMenuItem( ah_MenuSetAgtStatus_hold );//good up to here

	}

	/* Agent informations */
	ah_MenuSeeAgtInfos = new menuItem(""+DoMenu[2]+" ", "menu_AgtInfos");
	ah_MenuSeeAgtInfos_1 = new jsDOMenu(220);
	...
	{
		ah_MenuSeeAgtMonitoring = new menuItem(""+DoMenu[3]+" ", "menu_AgtMonitor","javascript:startLiveMonitoring()", true);
		//ah_MenuSeeAgtMonitoring_1 = new jsDOMenu(200);
		...
		//ah_MenuSeeAgtMonitoring_watch = new menuItem(""+MultiArray["Watch live"][lang]+" ", "menu_AgtSeeMonitorWatch", "javascript:startWatcher()", true);
		
		//ah_MenuSeeAgtMonitoring_1.addMenuItem( ah_MenuSeeAgtMonitoring_listen );
		//ah_MenuSeeAgtMonitoring_1.addMenuItem( ah_MenuSeeAgtMonitoring_watch );
	...
	{
		ah_MenuSetAgtPorperties = new menuItem(""+DoMenu[4]+" ", "menu_AgtPorperties", "javascript:showAgentProps()");
	...
	ah_AgtFilter = new Array("td.agentStatsLine", "IMG.agentImageStatus");
	ah_AgtMenuObj.setNoneExceptFilter(ah_AgtFilter);
	
	
	/**** AGENTS GROUPS ****/		
	ah_GrpMenuObj 	= new jsDOMenu(160);
	...
	if(userHasRight("ALLOW_MANAGER_CHANGE_AGENT_STATUS"))
	{
		ah_MenuSetGrpStatus = new menuItem(""+DoMenu[5]+"", "menu_GrpStatus");
		ah_MenuSetGrpStatus_1 = new jsDOMenu(160);
		/*****  For future use ******
		...
		{
			ah_MenuSetGrpStatus_logout = new menuItem(""+DoMenu[6]+"", "menu_GrpStatus_logout", "javascript:forceGroupStatus('LOGGED_OUT')", true);
	...
	{
		ah_MenuSetGrpPorperties = new menuItem(""+DoMenu[4]+" ", "menu_GrpPorperties", "javascript:showGroupProps()");
	...
	ah_MenuSetGrpStatistics = new menuItem(""+DoMenu[7]+" ", "menu_GrpStatistics", "javascript:showGroupStats()");
		
		ah_GrpMenuObj.addMenuItem( ah_MenuSetGrpStatistics );
		if(ah_GrpMenuObj.items["menu_GrpStatistics"])
			ah_GrpMenuObj.items.menu_GrpStatistics.showIcon("icon_props");
	...
	ah_MenuSetCamStats = new menuItem(""+DoMenu[7]+" ", "menu_CmpStatistics", "javascript:showCmpStats()");
	ah_CamMenuObj.addMenuItem( ah_MenuSetCamStats );
	/*
	ah_CamMenuObj 	= new jsDOMenu(150);
	ah_MenuCamName 	= new menuItem("", "menu_CamName", "", "", "jsdomenuitem_title", "jsdomenuitemover_title");
