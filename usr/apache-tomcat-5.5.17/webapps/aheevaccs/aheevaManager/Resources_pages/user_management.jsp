...
<%@ include file="userManagementFunctions_labels.jsp" %>
...
<body class="use_man_body" TEXT="#000000" LINK="#000066" VLINK="#666666" > 
	...
	<div class="tab-page" id="tabPrivileges">
		...
		<table width="100%"><tr><td width="50%" align="left" valign="top">
				...
				<table cellpadding="0" cellspacing="0" width="100%">
					...
					<tr><td><%=pageData.getWord("Evaluation forms")%></td><td width="20"><input type="checkbox" onClick="boxclicked_byuser(this.name, this.checked)"  id="ALLOW_QUALITY_MONITORING_AGENTLISTENING_FORM_MANAGEMENT" name="ALLOW_QUALITY_MONITORING_AGENTLISTENING_FORM_MANAGEMENT"></td></tr>
				...
				<fieldset><legend><%=pageData.getWord("Form Builder") %></legend>
				<table cellpadding="0" cellspacing="0" width="100%">
				   <tr><td><%=pageData.getWord("Form Builder") %></td><td width="20"><input type="checkbox" onClick="boxclicked_byuser(this.name, this.checked)" id="ALLOW_POPUP_BUILDER" name="ALLOW_POPUP_BUILDER"></td></tr>
				</table>   
				</fieldset><br>
		</tr></table>
	</div>
