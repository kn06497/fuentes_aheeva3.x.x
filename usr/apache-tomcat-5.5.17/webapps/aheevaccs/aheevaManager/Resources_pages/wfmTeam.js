...
function displayTeamInfo()
{
	...
	if(teamName== '')
	{
		ourCaption.innerHTML = "<b>"+wfm[0]+"</b>";
		document.teamInfo.updateInfo.value =  ""+wfm[0]+"";
		document.teamInfo.nonConfiguredAgents.disabled = true;
		document.teamInfo.availableAgentInTeam.disabled = true;
	}
	else
	{
		ourCaption.innerHTML = "<b>"+wfm[1]+"</b>";
		document.teamInfo.updateInfo.value = ""+wfm[2]+"";
	}
