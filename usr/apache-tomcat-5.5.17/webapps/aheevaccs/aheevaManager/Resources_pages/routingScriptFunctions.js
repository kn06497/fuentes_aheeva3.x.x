...
var vectorSetAttachedData = new Array();	//Liste des SetAttachedData
...
var nbSetAttachedData = 0;	//Nombre de Attached Data crees jusque la
...
/****-> Si des propri�t�s sont ajout�s, il FAUT modifier la fonction testCallPropertyValue() du fichier actuel*/
var vectorOfCallProperties = new Array();
// "Global" call properties are those the user can set in the "Add property"
// box of the "Edit properties"
var vectorOfGlobalCallProperties = new Array();

// Got some call properties available in all scripts
tOption = new Option("ANI", "ANI");
vectorOfGlobalCallProperties.push(tOption);
...
vectorOfGlobalCallProperties.push(tOption);
//tOption = new Option("DAYOFWEEK", "DAYOFWEEK"); /*Ex.:1, 2, ...*/
//vectorOfGlobalCallProperties.push(tOption);
tOption = new Option("DAYNAME", "DAYNAME"); /*Ex.:Sunday, Monday, ...*/
vectorOfGlobalCallProperties.push(tOption);
//tOption = new Option("MONTHOFYEAR", "MONTHOFYEAR"); /*Ex.:1, 2, ... */
//vectorOfGlobalCallProperties.push(tOption);
tOption = new Option("MONTHNAME", "MONTHNAME"); /*Ex.:January, February, ... */
vectorOfGlobalCallProperties.push(tOption);
tOption = new Option("WEEKDAY", "WEEKDAY"); /*Ex.:Yes, No */
vectorOfGlobalCallProperties.push(tOption);
tOption = new Option("broadcast", "broadcast");
vectorOfGlobalCallProperties.push(tOption);
tOption = new Option("amdstatus", "amdstatus");
vectorOfGlobalCallProperties.push(tOption);

/* ___ initiate the day properties ___ */
//ATTENTION -> CHANGER L'ORDRE DES DONNEES REQUIERT MODIFICATION AU CODE
vectorOfDayName = new Array();
tOption = new Option("1-MONDAY", "1-MONDAY");
vectorOfDayName.push(tOption);
tOption = new Option("2-TUESDAY", "2-TUESDAY");
vectorOfDayName.push(tOption);
tOption = new Option("3-WEDNESDAY", "3-WEDNESDAY");
vectorOfDayName.push(tOption);
tOption = new Option("4-THURSDAY", "4-THURSDAY");
vectorOfDayName.push(tOption);
tOption = new Option("5-FRIDAY", "5-FRIDAY");
vectorOfDayName.push(tOption);
tOption = new Option("6-SATURDAY", "6-SATURDAY");
vectorOfDayName.push(tOption);
tOption = new Option("7-SUNDAY", "7-SUNDAY");
vectorOfDayName.push(tOption);

/* ___ initiate the day properties ___ */
//ATTENTION -> CHANGER L'ORDRE DES DONNEES REQUIERT MODIFICATION AU CODE
vectorOfDayNumber = new Array();
tOption = new Option("1", "1");
vectorOfDayNumber.push(tOption);
tOption = new Option("2", "2");
vectorOfDayNumber.push(tOption);
tOption = new Option("3", "3");
vectorOfDayNumber.push(tOption);
tOption = new Option("4", "4");
vectorOfDayNumber.push(tOption);
tOption = new Option("5", "5");
vectorOfDayNumber.push(tOption);
tOption = new Option("6", "6");
vectorOfDayNumber.push(tOption);
tOption = new Option("7", "7");
vectorOfDayNumber.push(tOption);

/* ___ initiate the month properties ___ */
//ATTENTION -> CHANGER L'ORDRE DES DONNEES REQUIERT MODIFICATION AU CODE
vectorOfMonthName = new Array();
tOption = new Option("1-JANUARY", "1-JANUARY");
vectorOfMonthName.push(tOption);
tOption = new Option("2-FEBRUARY", "2-FEBRUARY");
vectorOfMonthName.push(tOption);
tOption = new Option("3-MARCH", "3-MARCH");
vectorOfMonthName.push(tOption);
tOption = new Option("4-APRIL", "4-APRIL");
vectorOfMonthName.push(tOption);
tOption = new Option("5-MAY", "5-MAY");
vectorOfMonthName.push(tOption);
tOption = new Option("6-JUNE", "6-JUNE");
vectorOfMonthName.push(tOption);
tOption = new Option("7-JULY", "7-JULY");
vectorOfMonthName.push(tOption);
tOption = new Option("8-AUGUST", "8-AUGUST");
vectorOfMonthName.push(tOption);
tOption = new Option("9-SEPTEMBER", "9-SEPTEMBER");
vectorOfMonthName.push(tOption);
tOption = new Option("10-OCTOBER", "10-OCTOBER");
vectorOfMonthName.push(tOption);
tOption = new Option("11-NOVEMBER", "11-NOVEMBER");
vectorOfMonthName.push(tOption);
tOption = new Option("12-DECEMBER", "12-DECEMBER");
vectorOfMonthName.push(tOption);

/* ___ initiate the month properties ___ */
//ATTENTION -> CHANGER L'ORDRE DES DONNEES REQUIERT MODIFICATION AU CODE
vectorOfMonthNumber = new Array();
tOption = new Option("1", "1");
vectorOfMonthNumber.push(tOption);
tOption = new Option("2", "2");
vectorOfMonthNumber.push(tOption);
tOption = new Option("3", "3");
vectorOfMonthNumber.push(tOption);
...
tOption = new Option("7", "7");
vectorOfMonthNumber.push(tOption);
tOption = new Option("8", "8");
vectorOfMonthNumber.push(tOption);
tOption = new Option("9", "9");
vectorOfMonthNumber.push(tOption);
tOption = new Option("10", "10");
vectorOfMonthNumber.push(tOption);
tOption = new Option("11", "11");
vectorOfMonthNumber.push(tOption);
tOption = new Option("12", "12");
vectorOfMonthNumber.push(tOption);

/* ___ initiate the weekday properties ___ */
//ATTENTION -> CHANGER L'ORDRE DES DONNEES REQUIERT  MODIFICATION AU CODE
vectorOfWeekDay = new Array();
tOption = new Option("0-NO", "0-NO");
vectorOfWeekDay.push(tOption);
tOption = new Option("1-YES", "1-YES");
vectorOfWeekDay.push(tOption);
...
function refreshDiagramInside()
{
	...
	{
		diagramInsideObj.innerHTML += vectorSetAttachedData[i].buildHTML();
	}
...
function saveThisScript()
{
	var i; var j;
	var bReturn = true;
//         alert("script modif" + scriptHasBeenModified);
	if(scriptHasBeenModified) //Verifi that this diagram is validate and a change has been made
	{
		...
		if(bReturn)
		{
			displayTmpMessage(""+rout[0]+" ...");  //Display the Saving Tmp Message will help the user wait...
			var buildString = "";
...
function Schema_to_String()
{
	...
	var buildString1="", buildString2="", buildString3="", buildString4="",
			...
			buildString10 = "", buildString11 = "", buildString12 = "", buildString13 = "";
	var i;	var j;
			for(i = 0; i < vectorCallConditions.length; i++)
			{
			...
			for(i = 0; i < vectorAgentPickupMethods.length; i++)
			{
				...
				buildString2 += '&';
				for(var j = 0; j < vectorAgentPickupMethods[i].vectorAssignedVariables.length; j++)
				{
					buildString2 += 'variable='+vectorAgentPickupMethods[i].vectorAssignedVariables[j];
					buildString2 += '&';
				}
			...
			for(i = 0; i < vectorSwitchCases.length; i++)
			{
				...
				for(j = 0; j < vectorSwitchCases[i].LinkTypeArray.length; j++) //For each application of this PbxExec
				{
					...
					buildString9 += '&';
		//alert("onsuccessVUID<" + i + "><" + j + "><" + vectorSwitchCases[i].OnSuccessVUIDArray[j]+">");
			...
			for(i = 0; i < vectorSetAttachedData.length; i++)
			{
				buildString13 += 'TYPE=SETATTACHEDDATA';
				buildString13 += '&';
				buildString13 += 'uID='+vectorSetAttachedData[i].uID;
				buildString13 += '&';
				buildString13 += 'VUID='+vectorSetAttachedData[i].VUID;
				buildString13 += '&';
				buildString13 += 'next='+vectorSetAttachedData[i].next;
				buildString13 += '&';
				buildString13 += 'nextVUID='+vectorSetAttachedData[i].nextVUID;
				buildString13 += '&';
				buildString13 += 'xPos='+vectorSetAttachedData[i].xPos;
				buildString13 += '&';
				buildString13 += 'yPos='+vectorSetAttachedData[i].yPos;
				buildString13 += '&';
				for(key in vectorSetAttachedData[i].variableMap) //For each variable
				{
					buildString13 += 'key='+key;
					buildString13 += '&';
					buildString13 += 'value='+vectorSetAttachedData[i].variableMap[key];
					buildString13 += '&';
				}
				buildString13 = buildString13.substring(0, buildString13.length-1);
				buildString13 += '^';
			}
			if(buildString13.length >= 1)
				buildString13 = buildString13.substring(0, buildString13.length-1);
	...
	for(i = 0; i < splitedString.length; i++)
	{
		...
		switch(myElementTable['TYPE'])
		{
			...
			case "AGENTPICKUP":
				...
				var variablesStart = curElement.indexOf("variable=");
				var variablesEnd = curElement.indexOf("&caller_exitkeys=");
				if(variablesStart > 0 && variablesEnd > 0)
				{
					var variablesString = curElement.substring(variablesStart, variablesEnd);
					var vars_pars = variablesString.split('&');
					for(var j = 0; j < vars_pars.length; j++)
					{
						splequal = vars_pars[j].split('=');
						if(splequal[0] == "variable")
							tmp.vectorAssignedVariables.push(splequal[1]);
					}
				}
			...
			case "GETSTATISTIC":
                ...
                tmp.MaxWaitTimeAnswer = myElementTable['MaxWaitTimeAnswer'];
                tmp.MinAbandonTime = myElementTable['MinAbandonTime'];
                tmp.MaxStatsAge = myElementTable['MaxStatsAge'];
			...
			case "SETATTACHEDDATA":
				tmp = new SetAttachedData();
				tmp.uID	= myElementTable['uID'];
				tmp.VUID = myElementTable['VUID'];
				tmp.xPos = myElementTable['xPos'];
				tmp.yPos = myElementTable['yPos'];
				tmp.next = myElementTable['next'];
				tmp.nextVUID = myElementTable['nextVUID'];
				variables = curElement.substring("TYPE=SETATTACHEDDATA".length+
												  "uID=".length+
												  tmp.uID.length+
												  "VUID=".length+
												  tmp.VUID.length+
				...
				{
					splequal = variablesArray[j].split('=');
					if(splequal[0] == "key")
					{
						key = splequal[1];
						var tmpOption = new Option(key, key);
						vectorOfCallProperties.push(tmpOption);
					}
					else if(splequal[0] == "value")
					{
						value = splequal[1];
						tmp.variableMap[key] = value;
					}
				}
				if(parseInt(myElementTable['uID']) > nbSetAttachedData)
					nbSetAttachedData = parseInt(myElementTable['uID']);
				if(parseInt(myElementTable['VUID']) > nbScrpElementCreated)
					nbScrpElementCreated = parseInt(myElementTable['VUID']);
				vectorSetAttachedData.push(tmp);
			break;
		}
	}

	// All variables set, update call properties
	differenciateGlobalCallProperties();
...
{
	displayTmpMessage(""+rout[1]+"..."); //Display a temporal message
	var tmpBool;
	...
	/* Make sur that another routing script with the same name doesn't already exists */
	var allroutes = String (appletObj.getRoutingScripts(tenantDBID , "1"));
	var allroutesarr = allroutes.split("|");
	for(var j = 0; j < allroutesarr.length; j++)
	{
		var thisroute = allroutesarr[j];
		var thisroutearr = thisroute.split(',');
		if(document.theForm.n_script_name.value == thisroutearr[1] && script_name != document.theForm.n_script_name.value)
		{
			alert(rout[4]);
			retrieveTmpMessage();
	...
	allroutes = String( appletObj.getRoutingScripts(tenantDBID , "0") );
	allroutesarr = allroutes.split("|");
	for(var j = 0; j < allroutesarr.length; j++)
	{
		var thisroute = allroutesarr[j];
		var thisroutearr = thisroute.split(',');
	...
	//Validate SetAttachedData
	for(i = 0; i < vectorSetAttachedData.length; i++)
	{
		if( !vectorSetAttachedData[i].validate() ) //des que le ieme n'est pas valide,
			return false;
	}
...
function menu_new_script()
{
	...
	if(cango)
	{
		var newloc = 'routingScript.jsp?tenant_dbid='+tenantDBID+'&tenantName='+tenantName;
...
{
	var yesno = confirm(rout[6].replace("**","\n").replace("**","\n"));
	if(yesno)
	{
	...
	if(curObj)
		{
			...
			var w;
			for(w = 0; w < vectorSetAttachedData.length; w++)
			{
				divName = "IDSetAttachedData_"+vectorSetAttachedData[w].uID;
				if(divName == lastDragCCName)
				{
					vectorSetAttachedData[w].xPos = curObj.left;
					vectorSetAttachedData[w].yPos = curObj.top;
					ObjDeplaceID = vectorSetAttachedData[w].uID;
					ObjDeplaceType = "SAD";
					break;
				}
			}
...
function addAddExtraData(theValue)
{
	if(!option_already_existInCallProps(theValue))
	{
		...
		vectorOfGlobalCallProperties.push(neopp);
	}
	updateCallProperties();
}
...
function option_already_existInCallProps(theValue)
{
	var bReturn = false;
	var i;
	for(i = 0; i < vectorOfGlobalCallProperties.length; i++)
	{
		if(vectorOfGlobalCallProperties[i].value == theValue)
		{
			bReturn = true;
			break;
		}
...
{
	buildSelectFromVector(document.popUpForm.available_call_props, vectorOfGlobalCallProperties);
...
function addNewCallProperty()
{
	if(document.popUpForm.new_call_property.value != "")
	{
		...
		buildSelectFromVector(document.popUpForm.available_call_props,
							  vectorOfGlobalCallProperties);
	}
...
function menu_new_open()
{
	...
	for(i = 0; i < jsRSCRIPTArray.length; i++)
	{
		if(jsRSCRIPTArray[i].length != 0)
		{
			...
			var the_url = "./routingScript.jsp?tenant_dbid="+tenantDBID+"&tenantName="+tenantName+"&script_dbid="+thisRScript[0]+"&script_name="+thisRScript[1]+"&script_is_active="+thisRScript[2]+"&script_priority="+thisRScript[3];
	...
	vectorOfScripts.sort(compareOptionsByText);
...
function compareOptionsByText(opt1, opt2)
{
...
function getBoxDivName(boxType, boxUid)
{
	...
	switch(boxType)
	{
		...
		break;
		case "SAD":
			startString = "IDSetAttachedData_";
		break;
	}
...
function menu_new_props()
{
	...
	buildHTML += '<tr><td colspan="2"><b>"'+rout[9]+'</b></td></tr>';
	var color = "#EEEEEE";
...
function softvalideNotMultipleStartingPoints()
{
	...
	} else
	{
		...
		else
		{
			...
			{
				tmptext = '';
				tmptext +=rout[12].replace("**","\n");
				tmptext += rout[13].replace("**","\n");
				for(var p = 0; p < list_of_cc_StartPoints.length; p++)
...
function testCallPropertyValue(callProp, callLink1, callLink2, callSeek, callOption){
	var n = callProp.selectedIndex;
	var str = callProp.options[n].value.toString();
	if (str == "WEEKDAY"){
		modifyTestWindow(vectorOfWeekDay, callSeek, callOption, callLink1, callLink2);
	}
	else if (str == "DAYNAME"){
		modifyTestWindow(vectorOfDayName, callSeek, callOption, callLink1, callLink2);
	}
	else if (str == "MONTHNAME"){
		modifyTestWindow(vectorOfMonthName, callSeek, callOption, callLink1, callLink2);
	}
	/*else if (str == "DAYOFWEEK"){
		modifyTestWindow(vectorOfDayNumber, callSeek, callOption, callLink2, callLink1);
	}
	else if (str == "MONTHOFYEAR"){
		modifyTestWindow(vectorOfMonthNumber, callSeek, callOption, callLink2, callLink1);
	}*/
	else{
		callOption.style.display = "none";// on efface le select pour le remplacer par le text field
		callSeek.style.display = "block"; // on affiche le champ de texte
		callLink2.style.display = "none";
		callLink1.style.display = "block";
	}
}

/**
@description:masque le champ de texte, et le remplace par un select cree a partir de l'array
@param a: array pour le select
@param callSeek: le champ de text� � masquer
@param callOption: le select � cr�er et afficher
*/
function modifyTestWindow(a, callParameterToHide, callParameterToDisplay, callLinkToHide, callLinkToDisplay){
	callParameterToDisplay.options.length = 0;
	callParameterToHide.style.display = "none"; // on masque le champ de texte pour le remplacer par un champ select
	buildSelectFromVector(callParameterToDisplay, a); // construction du select
	callParameterToDisplay.style.display = "block";
	callLinkToHide.style.display = "none";
	callLinkToDisplay.style.display = "block";
}

// Sorting of the the global call properties from the
// attached properties
function differenciateGlobalCallProperties()
{
	// Look at the global call properties to see if they're
	// attached, removing them from the list when required
	for(var i = 0; i < vectorOfGlobalCallProperties.length; i++) {
		for(var j = 0; j < vectorSetAttachedData.length; j++) {
			var sat = vectorSetAttachedData[j];
			for(var v in vectorSetAttachedData[j].variableMap)
				if (v == vectorOfGlobalCallProperties[i].value)
					vectorOfGlobalCallProperties.slice(i--,1);
		}
	}
}

// Update (rebuild) of the vector of call properties
function updateCallProperties()
{
	// Resetting that list
	vectorOfCallProperties.length = 0;

	// Add the global ones
	for(var i = 0; i < vectorOfGlobalCallProperties.length; i++) {
		vectorOfCallProperties.push(vectorOfGlobalCallProperties[i]);
	}

	// Then the properties from attached data
	for (var i = 0; i < vectorSetAttachedData.length; i++) {
		for (var v in vectorSetAttachedData[i].variableMap) {
			// The variable could already be in the list
			var found = false;
			for (k = 0; k < vectorOfCallProperties.length; k++) {
				if (v == vectorOfCallProperties[k]) {
					found = true;
					break;
				}
			}
			...
			if (!found) {
				// New variable, just add it to the list
				vectorOfCallProperties.push(new Option(v,v));
			}
		}
	}

	// Update of all the pickup methods assigned variables
	for(var i = 0; i < vectorAgentPickupMethods.length; i++)
	{
		var pm = vectorAgentPickupMethods[i];
		for(var j=0; j < pm.vectorAssignedVariables.length; j++) {
			// Looking if those assigned variables still exist
			var found = false;
			for(var k = 0; k < vectorOfCallProperties.length; k++) {
				if (vectorOfCallProperties[k].value ==
						pm.vectorAssignedVariables[j]) {
					found = true;
					break;
				}
			}
			...
			/*if(!found) {
				// Remove it
				pm.vectorAssignedVariables.splice(j--,1);
			}*/
		}
	}
}
