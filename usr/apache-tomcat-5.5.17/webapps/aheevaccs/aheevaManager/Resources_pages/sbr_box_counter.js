...
function CounterBox()
	{
		...
		this.buildHTML = function()
		{
			...
			sReturn += '<tr bgcolor="#E1E8E3"><td nowrap width="90%" style="cursor:move;" onMouseDown="dragThis(\'IDCounterBox_'+this.uID+'\')"><b>'+countr[0]+' #'+this.uID;
			if(DEBUG)
			...
			sReturn += '<tr><td colspan="2" class="entryTD" onClick="setUpPotentialEndLnk(\''+this.uID+'\', \'CO\', \''+this.VUID+'\')"><i>'+countr[1]+'</i></td></tr>';
			...
			sReturn += '<tr><td colspan="2" nowrap class="entryTD" onClick="setUpPotentialStartLnk(\''+this.uID+'\', \'OnNext\', \'CO\', \''+this.VUID+'\')"><i>'+countr[2]+'';
			if(DEBUG)
