...
function CustomServer()
{
	...
	this.buildHTML = function()
	{
		...
		sReturn += '<tr bgcolor="#F0D7CA"><td nowrap width="90%" style="cursor:move;" onMouseDown="dragThis(\'IDCustomServer_'+this.uID+'\')"><b>'+custom[0]+' #'+this.uID;
		if(DEBUG)
		...
		sReturn += '<tr><td colspan="2" class="entryTD" onClick="setUpPotentialEndLnk(\''+this.uID+'\', \'CS\', \''+this.VUID+'\')"><i>'+custom[1]+'</i></td></tr>';
		...
		sReturn += '';
		sReturn += '<tr><td colspan="2" nowrap class="onsuccedTD" onClick="setUpPotentialStartLnk(\''+this.uID+'\', \'onNext\', \'CS\', \''+this.VUID+'\')"><i>'+custom[2]+'';
		if(DEBUG)
