...
var w_monthname=new Array(""+WeekCa[0]+"",""+WeekCa[1]+"",""+WeekCa[2]+"",""+WeekCa[3]+"",""+WeekCa[4]+"",""+WeekCa[5]+"",""+WeekCa[6]+"",""+WeekCa[7]+"",""+WeekCa[8]+"",""+WeekCa[9]+"",""+WeekCa[10]+"",""+WeekCa[11]+"");
var w_dayname = new Array(""+WeekCa[24]+"",""+WeekCa[25]+"",""+WeekCa[26]+"",""+WeekCa[27]+"",""+WeekCa[28]+"",""+WeekCa[29]+"",""+WeekCa[30]+"");
...
function w_writeDayname()
{
    ...
    document.write('<td class="week" id="weekHeader">'  +WeekCa[12] + '</td>');
