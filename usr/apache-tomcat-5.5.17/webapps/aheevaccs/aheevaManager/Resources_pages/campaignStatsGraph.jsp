...
<body>
<fieldset>
		<legend><%= pageCamsData.getWord("Statistics") %></legend>
		<table border="0">
			<tr style="BACKGROUND-COLOR: #c4e0f0">
				<td colSpan="2">
					<script><%= pageCamsData.getWord("Campaign")%> [
			...
			<tr>
				<td colSpan="2">
					<script language="javascript" type="text/javascript">
							...
							document.write('<PARAM name="LOADINGMESSAGE" value="<%= pageCamsData.getWord("Creating Chart - Please Wait.")%>">');
							...
							document.write('<PARAM name="legendtitle"      value="<%= pageCamsData.getWord("Dials")%>">');
							...
							document.write('<PARAM name="pie1label1" value="<%= pageCamsData.getWord("Answered")%>">');
							document.write('<PARAM name="pie1label2" value="<%= pageCamsData.getWord("No answer")%>">');
							document.write('<PARAM name="pie1label3" value="<%= pageCamsData.getWord("Abandoned")%>">');
							document.write('<PARAM name="pie1label4" value="<%= pageCamsData.getWord("Answer machine")%>">');
							document.write('<PARAM name="pie1label5" value="<%= pageCamsData.getWord("SIT")%>">');
							document.write('<PARAM name="pie1label6" value="<%= pageCamsData.getWord("Busy")%>">');
							document.write('<PARAM name="pie1label7" value="<%= pageCamsData.getWord("Fax")%>">');
							
							
							document.write('<!-- Segment Data -->');
							document.write('<!-- segmentN       series color|legend label|URL|Target Frame -->');
							document.write('<PARAM name="segment1" value="115,152,164|<%= pageCamsData.getWord("Answered")%>">');
						    document.write('<PARAM name="segment2" value="99,99,156|<%= pageCamsData.getWord("No answer")%>">');
							document.write('<PARAM name="segment3" value="185,53,8|<%= pageCamsData.getWord("Abandoned")%>">');
							document.write('<PARAM name="segment4" value="239,214,115|<%= pageCamsData.getWord("Answer machine")%>">');
							document.write('<PARAM name="segment5" value="0,63,68|<%= pageCamsData.getWord("SIT")%>">');
							document.write('<PARAM name="segment6" value="17,97,158|<%= pageCamsData.getWord("Busy")%>">');
							document.write('<PARAM name="segment7" value="17,97,0|<%= pageCamsData.getWord("Fax")%>">');
