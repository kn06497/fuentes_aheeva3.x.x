...
function setCurrentAgentGlobals(agtName, agtLogin, agtTenant, agtIP, agtHost, agtAst, agtPhoneVersion)
{
	...
	ah_MenuSeeAgtInfos_1.items["menu_AgtSeeInfosHost"].setDisplayText(tops[0]+curAgtHost+"]");
	ah_MenuSeeAgtInfos_1.items["menu_AgtSeeInfosAsterisk"].setDisplayText(tops[1]+curAgtAst+"]");
	ah_MenuSeeAgtInfos_1.items["menu_AgtSeeInfosStarPhone"].setDisplayText(tops[2]+curAgtPhoneVersion+"]");
