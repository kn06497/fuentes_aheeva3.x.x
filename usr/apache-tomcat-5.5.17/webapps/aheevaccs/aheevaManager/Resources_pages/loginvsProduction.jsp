...
body {
	...
	background-image: url(../img/rep_body.png);
...
<!-- Calendrier début -->
<%@ include file="loginvsProduction_labels.jsp" %>
...
<body  class="rep_body" onLoad="fillCombos()">
...
<form name="agentHours"  action="./loginvsProduction.jsp" method="post"  >
	<script type="text/javascript">
	  ...
	  <div class="tab-page" id="searchoptions">
	  	<h2 class="tab"><%= pageLogvData.getWord("Daily hours")%></h2>

			<script type="text/javascript">
				tp1.addTabPage( document.getElementById( "searchoptions" ) );
			</script>
			<fieldset>
				<legend><%= pageLogvData.getWord("Search options")%></legend>
				<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1455">
					...
					<tr>
						<td width="276" height="23" style="border-left-style: none; border-left-width: 1; border-top-style: none; border-top-width: 1">
							<b><%= pageLogvData.getWord("Select a date")%> </b>						</td>
						<td width="9" ></td>
						...
						<td width="907">
							<input disabled id="saveModified2"  name="saveModified" type="button" style="visibility:visible;" value="<%= pageLogvData.getWord("Save modified")%>" onClick="saveTheModified()">
							<input disabled id="closeThisDay"  name="closeThisDay" type="button" style="visibility:visible;" value="<%= pageLogvData.getWord("Close this day")%>" onClick="closeTheDay()">&nbsp;&nbsp;<!--onClick="/*validatePassword();*/"-->						</td>
					</tr>
					<tr>
						<td width="276" height="23" style="border-left-style: none; border-left-width: 1; border-top-style: none; border-top-width: 1">
							<b><%= pageLogvData.getWord("Select an agent group")%></b>						</td>
						<td width="9" ></td>
						<td width="288" style="border-top-style: none; border-top-width: 1">
							<select id="agtGrp" name="agtGrp" onChange="javascript:getAgentsInGroup(this,document.agentHours.objects,document.agentHours.Checkbox2)" class="contentText" >
								<option value="AllGroups">- <%= pageLogvData.getWord("All groups")%> -</option>
							</select>						</td>
						<td valign="middle" >&nbsp;
							<b><%= pageLogvData.getWord("Show agent by ID")%> <input type="checkbox" name="viewckbox" onClick="javascript:changeAgentListView(document.agentHours.agtGrp, document.agentHours.objects, this);" id="Checkbox2"></b>
					...
					<tr>
						<td width="276" height="23" style="border-left-style: none; border-left-width: 1; border-top-style: none; border-top-width: 1">
							<b><%= pageLogvData.getWord("Select an agent")%></b>						</td>
						<td width="9" ></td>
						<td width="288" id="id_reportDate" style="border-top-style: none; border-top-width: 1">
							...
							<select id="objects" name="objects" multiple="multiple" class="contentText">
								<option value="AllAgents" selected>- <%= pageLogvData.getWord("All agents")%> -</option>
							</select>						
						
						</td>
						<td valign="top">
		    <input id="viewAgentsHours"  name="viewAgentsHours" type="button"  value="<%= pageLogvData.getWord("View data")%>" onClick="extractAllData()">
			...
			<table border="1" class="reportsTabName" style="border-collapse:collapse " bordercolor="#CCCCCC">
			  <tr>
				<td align="center" width="100"><b><%= pageLogvData.getWord("Agent ID")%></b></td>
				<td align="center" width="200"><b><%= pageLogvData.getWord("Last name")%>,<%= pageLogvData.getWord("First name")%></b></td>
				<td align="center" width="150"><b><%= pageLogvData.getWord("Agent group")%></b></td>
				<td align="center" width="125"><b><%= pageLogvData.getWord("Activity")%></b></td>
				<td align="center" width="125"><b><%= pageLogvData.getWord("Login time")%></b></td>
				<td align="center" width="125"><b><%= pageLogvData.getWord("Paid time")%></b></td>
				<td align="center" width="80"><b><%= pageLogvData.getWord("Override")%></b></td>
				<td align="center" width="125"><b><%= pageLogvData.getWord("Correction")%></b></td>
				<td align="center" width="125"><b><%= pageLogvData.getWord("Override time")%></b></td>
				<td align="center" width="150"><b><%= pageLogvData.getWord("Override cause")%></b></td>
				<td align="center" width="150"><b><%= pageLogvData.getWord("Custom cause")%></b></td>
			  </tr>
			</table>
			</div>
					 ...
					 %>
						...
						<td align="center" width="150">
						  <select name="selectoverridecause<%=id_suff%>" id="selectoverridecause<%=id_suff%>" onChange="viewOverrideCause(this.id)" disabled>
							<option value="No comments"><%= pageLogvData.getWord("Select")%></option>
							<option value="Starphone crash"><%= pageLogvData.getWord("Starphone crash")%></option>
							<option value="Fire alarm"><%= pageLogvData.getWord("Fire alarm")%></option>
							<option value="Computer crash"><%= pageLogvData.getWord("Computer crash")%></option>
							<option value="Power failure"><%= pageLogvData.getWord("Power failure")%></option>
							<option value="Agent displacement"><%= pageLogvData.getWord("Agent displacement")%></option>
							<option value="Sent Home (3hrs paid)"><%= pageLogvData.getWord("Sent Home (3hrs paid)")%></option>
							<option value="First day integration"><%= pageLogvData.getWord("First day integration")%></option>
							<option value="Floor support"><%= pageLogvData.getWord("Floor support")%></option>
							<option value="HR interview"><%= pageLogvData.getWord("HR interview")%></option>
							<option value="Other"> <%= pageLogvData.getWord("Other")%></option>
						  </select>
	...
	<div class="tab-page" id="addRow" >
		<h2 class="tab"><%= pageLogvData.getWord("Add a row")%></h2>
		<script type="text/javascript">
			...
			<table border="0" width="80%" cellpadding="2" cellspacing="0" style="border-collapse: collapse">
				<tr>			
					<td style="border-top-style: none; border-top-width: 1">
						<label for="agtGrp2"><b><%= pageLogvData.getWord("Select an agent group")%></b></label>					
					</td>
				...
				<tr>			
					<td><label for="objects2"><b><%= pageLogvData.getWord("Select an agent")%></b></label></td>
					<td align="left" >
						<select id="objects2" name="objects2" class="contentText" >
							<option value="AllAgents">- <%= pageLogvData.getWord("All agents")%> -</option>
						</select>					
					</td>					
				    <td align="left">		
						<label for"viewckbox2"><b><%= pageLogvData.getWord("Show agent by ID")%></b></label>
				...
				<tr>
				  <td><label for="reportDate2"><b><%= pageLogvData.getWord("Select a date")%></b></label></td>
				...
				<tr>
					<td align="center" colspan="3">
						<table>
							<td style="border-top-style: none; border-top-width: 1">
							<input id="addARow"  name="addARow" type="button" style="visibility:visible;" value="<%= pageLogvData.getWord("Add a row")%>" onClick="addMyRow(document.agentHours.agtGrp2,document.agentHours.objects2, document.agentHours.viewckbox2)">	</td>
							<td valign="middle">
							<input disabled id="saveRows"  name="saveRows" type="button" style="visibility:visible;" value="<%= pageLogvData.getWord("Save rows")%>" onClick="saveMyRows()">				</td>
						</table>					
					</td>					
				</tr>
			</table>
	...
	<div class="tab-page" id="exception">
		<h2 class="tab"><%= pageLogvData.getWord("Exceptions")%></h2>
		<script type="text/javascript">
		...
		<fieldset>
				<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1625">
					...
					<tr>
						...
						<td width="11" ></td>
						<td width="299" style="border-top-style: none; border-top-width: 1">&nbsp;<b><%= pageLogvData.getWord("Select start date")%></b>
							<input type="text" size="15" onFocus="showCalendar('',this,this,'','id_fromDate',0,30,1);this.blur()" name="fromDate" id="fromDate" value=""/>						
						<td width="948">&nbsp;<b><%= pageLogvData.getWord("Select stop date")%></b>
					...
					<tr>
						...
						<td valign="middle" >&nbsp;
						<input id="displayExceptions"  name="displayExceptions" type="button" style="visibility:visible;" value="<%= pageLogvData.getWord("View exceptions")%>" onClick="viewExceptions()">&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<table border="1" class="reportsTabName" style="border-collapse:collapse " bordercolor="#CCCCCC">
			  <tr>
			  	<td align="center" width="100"><b><%= pageLogvData.getWord("Date")%></b></td>
				<td align="center" width="100"><b><%= pageLogvData.getWord("Agent ID")%></b></td>
				<td align="center" width="200"><b><%= pageLogvData.getWord("Last name")%>,<%= pageLogvData.getWord("First name")%></b></td>
				<td align="center" width="150"><b><%= pageLogvData.getWord("Agent group")%></b></td>
				<td align="center" width="125"><b><%= pageLogvData.getWord("Activity")%></b></td>
				...
				<td align="center" width="150"><b><%= pageLogvData.getWord("Override cause")%></b></td>
				<td align="center" width="150"><b><%= pageLogvData.getWord("Custom cause")%></b></td>
				<td align="center" width="150"><b><%= pageLogvData.getWord("Override by")%></b></td>
        ...
        <table height="54" border="0">
					...
					for (int i = 0; i < exceptionData.size(); i++)
					{
						...
						<td align="center" width="150"><%//=anAgentActivityData.comments%>
						  <select name="selectoverridecause<%=id_suff%>" id="selectoverridecause<%=id_suff%>" onChange="viewOverrideCause(this.id)" disabled>
							<option value="No comments"><%= pageLogvData.getWord("Select")%></option>
							<option value="System failure"><%= pageLogvData.getWord("System failure")%></option>
							<option value="Working at Fido"><%= pageLogvData.getWord("Working at Fido")%></option>
	...
	<div class="tab-page" id="summary">
		<h2 class="tab"><%= pageLogvData.getWord("Summary")%></h2>
		<script type="text/javascript">
				tp1.addTabPage( document.getElementById( "summary" ) );
		</script>
		<fieldset>
		<legend><%= pageLogvData.getWord("View agent groups hours summary")%></legend>
		<table width="100%">
			<tr border="1" class="reportsTabName" style="border-collapse:collapse " bordercolor="#CCCCCC">
			<td align="center" width="20%"><b><%= pageLogvData.getWord("Name")%></b></td>
			<td align="center" width="35%"><b><%= pageLogvData.getWord("Queue")%></b></td>
			<td align="center" width="15%"><b><%= pageLogvData.getWord("Login time")%></b></td>
			<td align="center" width="15%"><b><%= pageLogvData.getWord("Paid time")%></b></td>
			<td align="center" width="15%"><b><%= pageLogvData.getWord("Billable")%></b></td>
			</tr>
		<%
			if ((submitRequest != null) && submitRequest.compareTo("true") == 0)
			{
