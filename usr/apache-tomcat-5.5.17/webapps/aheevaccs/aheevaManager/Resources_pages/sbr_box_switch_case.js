...
function SwitchCase()
{
	...
	{			
		...
		sReturn += '<tr bgcolor="#E8E0DB"><td nowrap width="90%" style="cursor:move;" onMouseDown="dragThis(\'IDSwitchCase_'+this.uID+'\')"><b>'+swtch[0]+' #'+this.uID;
		if(DEBUG)
		...
		sReturn += '<tr><td colspan="2" class="entryTD" onClick="setUpPotentialEndLnk(\''+this.uID+'\', \'SC\', \''+this.VUID+'\')"><i>'+swtch[1]+'</i></td></tr>';
		...
		sReturn += '<tr><td colspan="2" nowrap class="onsuccedTD" onClick="setUpPotentialStartLnk(\''+this.uID+'\', \'onDEFAULT\', \'SC\', \''+this.VUID+'\')"><i>'+swtch[2]+'';
		if(DEBUG)
