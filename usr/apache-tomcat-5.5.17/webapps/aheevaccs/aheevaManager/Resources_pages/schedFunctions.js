...
function setColumHeadersValue()
{
   ...
   var colHeader = new Array("",""+sched[4]+"",""+sched[5]+"",""+sched[6]+"",""+sched[7]+"",""+sched[8]+"",""+sched[9]+"",""+sched[10]+"");

    //Set array for row header data
    for(i=0;i<cols;i++){
     dataTable[0][i]= colHeader[i];
	 //dataTable[0][i].style.fontSize ='14pt';
	 }
...
function setRowHeadersValue()
{
	   ...
	   for(i = 0; i<rows; i++)
 	   ...
 	   dataTable[0][0]=" " +sched[0];//" Time hh:mm";
...
function loadtable()
{
	...
	//table.setPositionAndStyleParams (20,150,1,1,75,25,document.getElementById("tabPage4"));
	table.setPositionAndStyleParams (20,150,2,2,65,18,document.getElementById("tabPage4"));
