...
beanManagerData pageQuPrFData = new beanManagerData();
System.out.println(session.getAttribute("USER_LANGUAGE"));
if( session.getAttribute("USER_LANGUAGE") != null )
	pageQuPrFData.setDefaultLanguage((String)session.getAttribute("USER_LANGUAGE"));
pageQuPrFData.openConnection();
%>
<%
	String percent ="";
				...
				<tr>
					<td  class="reportsID" width="100%" align="center">
						<b>
							...
							%>
							<%= pageQuPrFData.getWord("Queue Reports")%>  <br><br>
							<%
			...
			<table width="100%" align="center">
				...
				<tr>
					<td width="100%" align="left"><font style="background-color:#FFC5A8">
						<b><%= pageQuPrFData.getWord("Data count")%> 			
						</b>
						</font>
						  <%
		...
		<td width="100%" align="center">
			<table width="90%" align="left" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName" height="15">
				<td width="25%" align="center"><%= pageQuPrFData.getWord("Time period")%> </td>
				<td width="25%"  align="center"><%= pageQuPrFData.getWord("Entered")%></td>
				<td width="25%"  align="center"><%= pageQuPrFData.getWord("Answered")%></td>
				<td width="25%"  align="center"><%= pageQuPrFData.getWord("Abandoned")%></td>
			  </tr>
			<%
			...
			%>
	 			<tr  height="15">
				 <td width="25%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%= pageQuPrFData.getWord("Total")%></b></font></td>
	...
	<tr>
		<td width="100%" align="center">
			<table width="100%" align="center">
				...
				<tr>
					<td width="100%" align="left"><font style="background-color:#FFC5A8">
						<b><%= pageQuPrFData.getWord("Percentages")%>			
						</b>
						</font>
						  <%
								NbEntered     = 0 ; ssTotNbEntered = 0; totNbEntered = 0 ;
		...
		<td width="100%" align="center">
			<table width="90%" align="left" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName" height="20">
				<td width="20%" align="center" > <%= pageQuPrFData.getWord("Time period")%> </td>
				<td width="20%"  align="center" colspan="2" ><%= pageQuPrFData.getWord("Answered")%></td>
				<td width="20%"  align="center" colspan="2" ><%= pageQuPrFData.getWord("Abandoned")%></td>
				<td width="20%"  align="center" colspan="2" ><%= pageQuPrFData.getWord("Answered service factor")%></td>
			...
			%>
			<tr>
				 <td width="20%"  bgcolor="#FFECF5" align="center" ><font  color="#000000"><b><%= pageQuPrFData.getWord("Total")%></b></font></td>
			...
			<table width="80%" align="center">
				...
				<tr>
					<td width="100%" align="left">
						<b>
							<%= pageQuPrFData.getWord("Service level")
							%>					
						</b>
					</td>
				</tr>
			...
			<table width="80%" align="center">
				<tr>
					<td width="100%" align="left" class="reportsID">
						<b>
							<%= pageQuPrFData.getWord("Answered calls")
							%>					
						</b>
					</td>
				</tr>
	...
	<tr>
		<td width="100%" align="center">
			<table width="80%" align="left" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName" height="20">
				<td width="20%"  align="center" ><%= pageQuPrFData.getWord("Answered")%> </td>
				<td width="20%" align="center" ><%= pageQuPrFData.getWord("Answered count")%></td>
				<td width="20%"  align="center" colspan="2" ><%= pageQuPrFData.getWord("Percentages")%></td>
			...
			%>
				<tr class="reportsQueueRow">
					 <td width="20%"  align="center" ><%out.write(pageQuPrFData.getWord("Within")+carac+pageQuPrFData.getWord("seconds"));%></td>
...
%>			
		...
		<td width="100%" align="center">
			...
			<tr><td height="20"></td></tr>
				<tr>
					<td width="100%" align="left" class="reportsID">
						<b>
							<%= pageQuPrFData.getWord("Abandonned calls")
								%>
						</b>
					</td>
				</tr>
	...
	<tr>
		<td width="100%" align="center">
			<table width="80%" align="left" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName" height="20">
				<td width="20%"  align="center" ><%= pageQuPrFData.getWord("Abandoned")%> </td>
				<td width="20%" align="center" ><%= pageQuPrFData.getWord("Abandon count")%></td>
				<td width="20%"  align="center" colspan="2" ><%= pageQuPrFData.getWord("Percentages")%></td>
