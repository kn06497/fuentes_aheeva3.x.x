			...
			<table width="70%" align="center">
				...
				<tr>
					<td  class="reportsID" width="100%" align="center"> 
						<b>
							<%= pageForecastdData.getWord("Daily Report for") %>
			...
			<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsForecastReport" height="25">
				...
				<td width="8%"  align="center" bgcolor="#FFFFFF">&nbsp;</td>
			  	<td width="8%"  align="center" ><%= pageForecastdData.getWord("Agents")%></td>
				<td width="8%"  align="center"><%= pageForecastdData.getWord("Phone")%></td>
				<td width="7%"  align="center"><%= pageForecastdData.getWord("Break")%></td>
				<td width="7%"  align="center" ><%= pageForecastdData.getWord("Lunch")%></td>
				<td width="8%"  align="center" ><%= pageForecastdData.getWord("Training")%></td>
				<td width="8%"  align="center"><%= pageForecastdData.getWord("Coaching")%></td>
				<td width="5%"  align="center" ><%= pageForecastdData.getWord("Abs")%></td>
				<td width="5%"  align="center" ><%= pageForecastdData.getWord("Quit")%></td>
				<td width="8%"  align="center" ><%= pageForecastdData.getWord("Shrinkage")%></td>
				<td width="7%"  align="center" ><%= pageForecastdData.getWord("Others")%></td>
				<td width="8%"  align="center" >AHT</td>
				<td width="7%"  align="center" ><%= pageForecastdData.getWord("Call")%></td>
			  </tr>
			  <%
				String key="";
				int sched =0;
			  	for(int i =0; i < beanGroupForecast.m_vAllData.size() ; i=i+1 )
				{
					...
					<tr class="reportsForecastShed" height="20">
							...
							<td align="center" bgcolor="#CC99CC"><%= pageForecastdData.getWord("Scheduled")%></td>
					...
					<tr class="reportsForecastActual" height="20">
						...
						<td align="center" bgcolor="#FFCCCC"><%= pageForecastdData.getWord("Actual")%></td>
					...
					<tr class="reportsForecastVariance" height="20">
						<td bgcolor="#FFFFFF" ><%out.write("    ");%></td>
						<td align="center" bgcolor="#FFCCCC"><%= pageForecastdData.getWord("Variance")%></td>
						<td align="center">
