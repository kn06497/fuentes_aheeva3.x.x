...
beanManagerData pagePrintLRData = new beanManagerData();
System.out.println(session.getAttribute("USER_LANGUAGE"));
if( session.getAttribute("USER_LANGUAGE") != null )
	pagePrintLRData.setDefaultLanguage((String)session.getAttribute("USER_LANGUAGE"));
pagePrintLRData.openConnection();
%>
<head>
<title>AheevaCCS - Line Usage Details Report1</title>
...
<fieldset>
	<table width="100%" cellpadding="0" cellspacing="0" align="center">
		...
		<tr><td width="100%" align="center"><b><%= pagePrintLRData.getWord("Line usage details")  %></b></td>
				</tr>				
	</table>		
	<tr>
	...
	<tr>
	  ...
	  <td width="100%" align="center"><table  width="70%" align="center" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
	  	...
	  	<td align="center" ><%= pagePrintLRData.getWord("Date & Time")%></td>
        <td  align="center"><%= pagePrintLRData.getWord("Peak within the hour")%></td>
		<td  align="center"><%= pagePrintLRData.getWord("Number of available lines")%></script></td>	
		</tr>		   	 
	  <%
	  try{
...
<% pagePrintLRData.closeConnection(); %>
