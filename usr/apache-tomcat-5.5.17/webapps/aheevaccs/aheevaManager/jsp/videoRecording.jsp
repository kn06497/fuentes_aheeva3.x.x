...
<!--<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111">-->
 ...
 for(cnt = 0;cnt < beanRecord.m_recDetails.size();cnt++){
  ...
  <script>
			...
			if (audioId > 0){
				document.write("<div class=\"menuitems\" target=\"blank\" url='../jsp/downloader.jsp?filePath=tempaudio/"+audioId+".wav&fileName="+audioId+".wav'>"+pageDataAgent.getWord("save Audio")+" </div>");
			}
			if (videoId > 0){
				document.write("<div class=\"menuitems\" target=\"blank\" url='../jsp/downloader.jsp?filePath=tempvideo/"+videoId+".swf&fileName="+videoId+".swf'>"+pageDataAgent.getWord("save Video")+" </div>");
			}
