				...
				<tr>
					<td  class="reportsID" width="100%" align="center">
						<b>
							...
							%>
							<%= pageRepdeData.getWord("Details Report for answered calls")%><br><br>
							<%
							if (reportType.compareTo("Daily") ==0){
				...
				<table width="100%" align="center">
					...
					<tr>
						<td width="100%" align="left"><font style="background-color:#FFC5A8">
							<b><%= pageRepdeData.getWord("Answered calls")%>	
							</b>
							</font>
						</td>
					</tr>			
		...
		<td width="100%" align="center">
			<table width="100%" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName">
				<td width="15%" align="center"><%= pageRepdeData.getWord("Time period")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Login time")%></td>
				<td width="5%"  align="center"><%= pageRepdeData.getWord("Login count")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Inbound time")%></td>
				<td width="5%"  align="center"><%= pageRepdeData.getWord("Inbound count")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Outbound time")%></td>
				<td width="5%"  align="center"><%= pageRepdeData.getWord("Outbound count")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Wrap up time")%></td>
				<td width="5%"  align="center"><%= pageRepdeData.getWord("Wrap up count")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Hold time")%></td>
				<td width="5%"  align="center"><%= pageRepdeData.getWord("Hold count")%></td>
			  </tr>
<%
...
%>
			 ...
			 <tr>
				 <td   bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%= pageRepdeData.getWord("Sub total")%></b></font></td>
...
<%
	...
	%>
	 <tr>
		 <td   bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%= pageRepdeData.getWord("Total")%></b></font></td>
	...
	<tr>
		<td width="100%" align="center">
			<table width="70%" align="left" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName">
				<td width="20%" align="center"> <%= pageRepdeData.getWord("Time period")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Inbound calls")%></td>
				<td width="10%"  align="center"> <%= pageRepdeData.getWord("Outbound calls")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Wrap up calls")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Hold calls")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("AHT in")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("AHT out")%></td>
			  </tr>
			<%
		for (int i = 0; i < beanAgentGroup.Detail_vector.size(); i++) {
			 groupsInfo = (beanAgentGlobalInfo)beanAgentGroup.Detail_vector.elementAt(i);
				...
				%>
			 <tr>
				 <td width="20%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%= pageRepdeData.getWord("Sub total")%></b></font></td>
			...
			%>
	 			<tr>
					<td   width="20%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%= pageRepdeData.getWord("Total")%></b></font></td>
		...
		<td width="100%" align="center">
			<table width="70%" align="left" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName">
				...
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Wrap up calls")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Hold calls")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Productivity")%></td>
				<td width="10%"  align="center"><%= pageRepdeData.getWord("Busy")%></td>
			  </tr>
			...
			for (int i = 0; i < beanAgentGroup.Detail_vector.size(); i++) {
 			...
 			<%
				...
				<tr <% if(i%2 == 0) out.write("class=reportsRowPair");
						...
						<td   align="center"><%out.write(groupsInfo.getProductivityRatio());%></td>
