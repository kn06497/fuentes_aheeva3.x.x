...
%>
<p align="center"><font size=4><b><%=pageDataAgent.getWord("Agent performance report")%></b></font><br><br></p>
...
<table width="480" border="0" align="center">
  <tr>
    <td   class="reportsID"><div align="center"><b><%=pageDataAgent.getWord("Agent performance")%>
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="850" id="AutoNumber1">
  <tr class="reportsTab">
    ...
    <td width="70" align="center"> <b><%=pageDataAgent.getWord("Group name")%></b> </td>

<%
   if(reportType.compareTo("Monthly") == 0) {
%>
    <td width="50"    align="center"> <b><%=pageDataAgent.getWord("Call time")%> &nbsp; <%=pageDataAgent.getWord("MM-AA")%></b> </td>
<%
   }else if (reportType.compareTo("Yearly") == 0) {
%>
    <td width="50"    align="center"> <b><%=pageDataAgent.getWord("Call time")%> &nbsp; <%=pageDataAgent.getWord("YY")%> </b> </td>
<%
   }else if(reportType.compareTo("Daily")== 0) { %>

    <td width="50"    align="center" nowrap> <b><%=pageDataAgent.getWord("Call time")%> &nbsp; <%=pageDataAgent.getWord("DD-MM-YY")%> </b> </td>
...
<%
  		...
  		out.write("<tr><td colspan=13><p><font size=2> "+pageDataAgent.getWord("Error whileError while generating Agent Performance Report...")+"</font></p></td></tr>");
   }
 %>
