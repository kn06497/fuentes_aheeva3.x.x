				...
				<tr>
					<td  class="reportsID" width="100%" align="center"> 
						<b>
							...
							%>
							<%= pageCrepdData.getWord("Campaign Reports")%>&nbsp; <%= pageCrepdData.getWord("for")%> <br><br>
							<%
							if (reportType.compareTo("Daily") ==0){
		...
		<td width="100%" align="center">
			<table width="90%" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName">
				  <td width="15%" align="center"><%= pageCrepdData.getWord("Time")%></td>
				  <td width="10%" align="center"><%= pageCrepdData.getWord("HitRate")%></td>
				  <td width="10%" align="center"><%= pageCrepdData.getWord("Dials")%></td>
				  <td width="10%" align="center"><%= pageCrepdData.getWord("Answered")%></td>
				  <td width="10%" align="center"><%= pageCrepdData.getWord("No answer")%></td>
				  <td width="10%" align="center"><%= pageCrepdData.getWord("Abandoned")%></td>
				  <td width="11%" align="center"><%= pageCrepdData.getWord("Answer machine")%></td>
				  <td width="8%" align="center"><%= pageCrepdData.getWord("SIT")%></td>
				  <td width="8%"  align="center"><%= pageCrepdData.getWord("Busy")%></td>
				  <td width="8%" align="center"><%= pageCrepdData.getWord("Fax")%></td>
			  </tr>
...
%>
				<tr>
				  <td bgcolor="#FFECF5" align="center"> <b><%= pageCrepdData.getWord("Total")%></b></font></td>
				  <td bgcolor="#FFECF5" align="center"> <b><%out.write(thRate);%> </b></font></td>
