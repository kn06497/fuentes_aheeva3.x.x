...
<head>
<title>AheevaCCS - Sheduled Agent's Reports1</title>
		...
		%>
			...
			<tr height="20"></tr>
				...
				<td width="100%" class="reportsID" align="center"><b>
					<b><%= reportData.getWord("Agent group")%></b>:   <%out.write(rp.getGroupName(agentGroup));%>  </b>
				 </td>
				</tr>
				<tr>
				 <td class="reportsID"><b>
					 <b><%= reportData.getWord("Scheduled")%> <%= reportData.getWord("agents")%> <%= reportData.getWord("From")%>:
					<%out.write(startingDateDaily);	%>
				   <%= reportData.getWord("To")%>
			...
			<td colspan="2" width="80" align="center"><%= reportData.getWord("Sunday")%></td>
			<td colspan="2" width="80" align="center"><%= reportData.getWord("Monday")%></td>
			<td colspan="2" width="80" align="center"><%= reportData.getWord("Tuesday")%></td>
			<td colspan="2" width="80" align="center"><%= reportData.getWord("Wednesday")%></td>
			<td colspan="2" width="80" align="center"><%= reportData.getWord("Thursday")%></td>
			<td colspan="2" width="80" align="center"><%= reportData.getWord("Friday")%></td>
			<td colspan="2" width="80" align="center"><%= reportData.getWord("Saturday")%></td>
			</tr>
			<tr>
			<td bgcolor='#ffffff'>&nbsp;</td><td bgcolor='#ffffff'>&nbsp;</td>
			<td></td>
			<td width="40" align="center"><%= reportData.getWord("Log in")%></td><td width="40" align="center"><%= reportData.getWord("Sched")%></td>
			<td width="40" align="center"><%= reportData.getWord("Log in")%></td><td width="40" align="center"><%= reportData.getWord("Sched")%></td>
			<td width="40" align="center"><%= reportData.getWord("Log in")%></td><td width="40" align="center"><%= reportData.getWord("Sched")%></td>
			<td width="40" align="center"><%= reportData.getWord("Log in")%></td><td width="40" align="center"><%= reportData.getWord("Sched")%></td>
			<td width="40" align="center"><%= reportData.getWord("Log in")%></td><td width="40" align="center"><%= reportData.getWord("Sched")%></td>
			...
			%>
				<tr >
				<td bgcolor='#ffffff'>&nbsp;</td><td bgcolor='#ffffff'>&nbsp;</td>
				<td bgcolor='#E4E4E4' align="center"><b><%= reportData.getWord("Scheduled Hours")%><%//out.write("Scheduled Hours***");%></b></td>
			...
			%>
				<tr  bgcolor="#FF91C8">
				<td bgcolor='#ffffff'>&nbsp;</td><td bgcolor='#ffffff'>&nbsp;</td>
				<td bgcolor='#E4E4E4' align="center"><b><%= reportData.getWord("Real hours (without breaks)")%><%//out.write("Real hours (without breaks)");%></b></td>
				<td  bgcolor='#E4E4E4'  colspan="2" align="center"><%out.write(Long.toString(r1.tot_time_sunday));%></td>
				<td  bgcolor='#E4E4E4'  colspan="2" align="center"><%out.write(Long.toString(r1.tot_time_monday));%></td>
				<td  bgcolor='#E4E4E4' colspan="2" align="center"><%out.write(Long.toString(r1.tot_time_tuesday));%></td>
				<td  bgcolor='#E4E4E4'  colspan="2" align="center"><%out.write(Long.toString(r1.tot_time_wednesday));%></td>
