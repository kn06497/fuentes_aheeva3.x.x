...
<head>
<title>AheevaCCS - Agent Reports1</title>
...
<form name="agentReports" action="">
	...
	</div><div class="tab-page" id="tabPage3">
...
<form name="agentReports" action="">
	...
	</div><div class="tab-page" id="tabPage2">
		<h2 class="tab"><%= page1Data.getWord("Unanswered")%></h2>
		<script type="text/javascript">tp1.addTabPage( document.getElementById( "tabPage2" ) );</script>
		<fieldset>
	    <%
