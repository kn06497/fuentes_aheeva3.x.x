...
<table align="right" border="0" width="25%" >
	...
	%>
		<td width="25%" align="center">
		<a href="queueReports.jsp?startingDateDaily=<%out.write(startingDateDaily) ;%>&endingDateDaily=<%out.write(endingDateDaily) ;%>&starting_year_yearly=<%out.write(starting_year_yearly) ;%>&ending_year_yearly=<%out.write(ending_year_yearly) ;%>&starting_month_monthly=<%out.write(starting_month_monthly) ;%>&starting_year_monthly=<%out.write(starting_year_monthly) ;%>&ending_month_monthly=<%out.write(ending_month_monthly) ;%>&ending_year_monthly=<%out.write(ending_year_monthly) ;%>&reportType=<%out.write(reportType) ;%>&objects=<%out.write(queues) ;%>&prec=-1&suiv=1&current=0&all_obj=1&lang=<% out.write(language); %>" ><b><%= pageQuRData.getWord("All")%></b></a>
		</td>
	<%
	}
	...
	{	
	%>
		<td width="25%" align="center"><a href="queueReports.jsp?startingDateDaily=<%out.write(startingDateDaily) ;%>&endingDateDaily=<%out.write(endingDateDaily) ;%>&starting_year_yearly=<%out.write(starting_year_yearly) ;%>&ending_year_yearly=<%out.write(ending_year_yearly) ;%>&starting_month_monthly=<%out.write(starting_month_monthly) ;%>&starting_year_monthly=<%out.write(starting_year_monthly) ;%>&ending_month_monthly=<%out.write(ending_month_monthly) ;%>&ending_year_monthly=<%out.write(ending_year_monthly) ;%>&reportType=<%out.write(reportType) ;%>&objects=<%out.write(queues) ;%>&prec=<% out.write(current) ;%>&suiv=<% out.write(new_suiv) ;%>&current=<% out.write(suiv) ;%>&all_obj=0&lang=<% out.write(language); %>" ><b><%= pageQuRData.getWord("Next")%></b></a>
		</td>
	<%
	}
	%>
...
<form name="queueReports">
	...
	<div class="tab-page" id="tabPage1">
		<h2 class="tab"><%= pageQuRData.getWord("General data")%></h2>
	...
	<div class="tab-page" id="tabPage2">
		<h2 class="tab"><%= pageQuRData.getWord("Percentages")%></h2>		
	...
	<div class="tab-page" id="tabPage3">
		<h2 class="tab"><%= pageQuRData.getWord("Statistics")%></h2>		
...
<form name="queueReports">
	...
	<div class="tab-page" id="tabPage1">
		<h2 class="tab"><%= pageQuRData.getWord("Data")%></h2>
		<script type="text/javascript">tp1.addTabPage( document.getElementById( "tabPage1" ) );  			 		
		</script>
		<fieldset>
	    <%
