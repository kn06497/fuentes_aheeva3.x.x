			...
			<table width="70%" align="center">
				...
				<tr>
					<td  class="reportsID" width="100%" align="center">
						<b>
							<%= pageRepstatsData.getWord("Generals statistics")%>&nbsp;<%= pageRepstatsData.getWord("for")%><br><br>
							<%
				...
				<table   <% if(detail.compareTo("1")==0 )  { out.write("width=100%"); out.write("align=left");}
					...
					<tr>
						<td width="100%" align="left"><font style="background-color:#FFC5A8">
							<b><%= pageRepstatsData.getWord("Generals statistics")%>				
							</b>
							</font>
						</td>
					</tr>			
	...
	<tr>
		<td width="100%" align="center">
			<table width="70%" align="center">
				...
				<tr>
					<td  class="reportsID" width="100%" align="center">
						<b>	<%= pageRepstatsData.getWord("Other statistics")%> </b>
					</td>
				</tr>			
			</table>
		</td>
		...
		<tr>
			<td width="100%" align="center">
				<table <% if(detail.compareTo("1")==0 )  { out.write("width=100%"); out.write("align=left");}
					...
					<tr>
						<td width="100%" align="left"><font style="background-color:#FFC5A8">
							<b><%= pageRepstatsData.getWord("Other statistics")%>				
							</b>
							</font>
						</td>
					</tr>			
			...
			<table <% if(detail.compareTo("1")==0 )  { out.write("width=100%"); out.write("align=left");}
			  ...
			  <tr><td height="20"></td></tr>
				  <tr >
					...
					<%= pageRepstatsData.getWord("Sheduled time")%></td>
				  ...
				  <tr >
					...
					<%= pageRepstatsData.getWord("Login")%></td>
					<td class="reportsTabValues" width="20%" style="border-style:solid; border-width:medium">
					<%
				  ...
				  <tr >
					<td class="reportsTabValues" width="35%" style="border-style:solid; border-width:medium">
					<%= pageRepstatsData.getWord("Adherence")%></td>
					<td class="reportsTabValues" width="20%" style="border-style:solid; border-width:medium">
					<%
