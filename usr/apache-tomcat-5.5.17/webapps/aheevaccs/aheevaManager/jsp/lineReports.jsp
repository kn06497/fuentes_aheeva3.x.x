...
<fieldset>
	...
	<table width="100%" cellpadding="0" cellspacing="0" align="center">
		...
		<tr><td width="100%" align="center"><b><%= pageLineRData.getWord("Line usage details")  %></b></td>
				</tr>				
	</table>		
	<tr>
	...
	<tr>
	  ...
	  <td width="100%" align="center"><table  width="70%" align="center" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
	  	...
	  	<td align="center" ><%= pageLineRData.getWord("Date & Time")%></td>
        <td  align="center"><%= pageLineRData.getWord("Peak within the hour")%></td>
		<td  align="center"><%= pageLineRData.getWord("Number of available lines")%></script></td>	
		</tr>		   	 
	  <%
	  try{
