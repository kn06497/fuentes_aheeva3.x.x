				...
				<tr>
					<td  class="reportsID" width="100%" align="center">
						<b>
							...
							%>
							<%= pageQuRdData.getWord("Queue Reports")%> <br><br>
							<%
							if (reportType.compareTo("Daily") ==0){
		...
		<td width="100%" align="center">
			<table width="90%" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName" height="15">
				<td width="25%" align="center"> <%= pageQuRdData.getWord("Time period")%></td>
				<td width="15%"  align="center"><%= pageQuRdData.getWord("Entered")%></td>
				<td width="15%"  align="center"><%= pageQuRdData.getWord("Answered")%></td>
				<td width="15%"  align="center"><%= pageQuRdData.getWord("Abandoned")%></td>
				<td width="15%"  align="center"><%= pageQuRdData.getWord("Abandoned - time out")%></td>
				<td width="15%"  align="center"><%= pageQuRdData.getWord("Abandoned - no agent")%></td>
			  </tr>
			<%
			for (int i = 0; i < beanQueue.m_vAllDetails.size(); i++) 
			{
				...
				<tr <% if(i%2 == 0) out.write("class=reportsRowPair");
					...
					<td align="center"> <%out.write(Long.toString(queueInfo.NbAbandonTimeOut));%>  </td>
					<td align="center"> <%out.write(Long.toString(queueInfo.NbAbandonNoAgt));%>  </td>
				  </tr>
			...
			%>
					 <tr  height="15">
						 <td width="25%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%= pageQuRdData.getWord("Sub total")%></b></font></td>
						 <td width="15%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(ssTotNbEntered_det));%></b></font></td>
						 <td width="15%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(ssTotNbAnswered_det));%></b></font></td>
						 <td width="15%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(ssTotNbAbandonned_det));%></b></font></td>
						 <td width="15%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(ssTotNbAbandonTimeOut_det));%></b></font></td>
						 <td width="15%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(ssTotNbAbandonNoAgt_det));%></b></font></td>
			...
			%>
	 			<tr  height="15">
				 <td width="25%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%= pageQuRdData.getWord("Total")%></b></font></td>			 
				 <td width="15%"bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(totNbEntered_det));%></b></font></td>
				 <td width="15%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(totNbAnswered_det));%></b></font></td>
				 <td width="15%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(totNbAbandonned_det));%></b></font></td>
				 <td width="15%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(totNbAbandonTimeOut_det));%></b></font></td>
				 <td width="15%" bgcolor="#FFECF5" align="center"><font  color="#000000"><b><%out.write(Long.toString(totNbAbandonNoAgt_det));%></b></font></td>
				</tr>
