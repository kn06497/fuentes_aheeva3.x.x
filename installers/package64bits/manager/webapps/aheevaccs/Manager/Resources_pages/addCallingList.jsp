...
<%@page import ="java.io.*"%>
<%@page import ="Manager.csvinterface.*"%>
	...
	Vector readCSVFile(String input, String csv_delimiter, String csv_quote, int maxLineToLoadFromFile) 
	{
		...
		try{
			...
			if(delim !='X' &&  quote !='X'){
				...
				CSVFileReader in = new CSVFileReader(input, delim, quote);
				CSVFileWriter pout = new CSVFileWriter("csv_out.txt");
...
<%
	...
	if(beanCList.source_file_name.compareTo("") == 0)
		beanCList.source_file_name 	= source_file_name;
	if(beanCList.csv_quote.compareTo("") == 0)	
		beanCList.csv_quote			= csv_quote;
	if(beanCList.csv_delimiter.compareTo("") == 0)
		beanCList.csv_delimiter		= csv_delimiter;
	if(beanCList.file_extension.compareTo("") == 0)
...
tp1 = new WebFXTabPane( document.getElementById( "tabPane1" ) );
	...
	<div class="tab-page" id="tabPage1">
		<h2 class="tab"><script>document.write(MultiArray["New"][lang]);</script></h2>
		...
		<fieldset>
				<legend>
					<%
						if(list_name.compareTo("")==0)
							...
							out.write("<script>document.write(MultiArray[\"New calling list wizard\"][lang]);</script>");
						else
							out.write(list_name +" <script>document.write(MultiArray[\"Calling list wizard\"][lang]);</script>");
					%>				
				</legend>  
				<%
				...
				%>
					<table>
						<tr>						
							<td><strong><script>document.write(MultiArray["List name"][lang]);</script></strong></td>
...
%>
						<tr>
							<td valign="top"><strong><%=pageData.getWord("Security")%></strong></td>
							<td colspan="2">
								<table>
									<tr>
...
%>
						<tr>
							...
							<td><select name="max_attempts" onChange="enabledNextButton()">
							...
							<td align="right"><strong><strong><script>document.write(MultiArray["Active"][lang]);</script></strong> 
								<input type="checkbox" name="state" value="ON" onClick="enabledNextButton()" checked>
							</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td colspan="2">
 								<input disabled name="nextInfo"  type="button" value="<%=pageData.getWord("Next")%> &gt;&gt;" onClick="addCList_next('<%=newCList_step%>')">
								<input name="finishedInfo" type="button" value="<%=pageData.getWord("Finished")%>" onClick="addCList_next('<%=newCList_step%>')" >
					...
					<table>
						<tr>
							<td>
								...
								<script>document.write(MultiArray["Delimiter"][lang]);</script> 
									<select name="csv_delimiter" disabled>
										<option value=""></option>
										<option value=",">,</option>
										<option value=";">;</option>
										<option value="tab"><script>document.write(MultiArray["tab"][lang]);</script> </option>
										<option value="space"><script>document.write(MultiArray["space"][lang]);</script> </option>
									</select> 
								&nbsp;&nbsp;&nbsp; 
								<script>document.write(MultiArray["Quote"][lang]);</script>
						...
						<tr>
							<td>
							<script>document.write(MultiArray["Source file name"][lang]);</script> :
							<input name="source_file_name" type="file" size="40" >
							</td>
						</tr>
						<tr>
							<td>
							<script>document.write(MultiArray["Load format"][lang]);</script>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
							<%
								java.sql.Statement  stat = null;
								java.sql.Connection conn = null;
								DataSource          m_ds = null;
						...
						<tr>
							<td>
							<script>document.write("<input name=\"nextInfo\"  type=\"button\" value=\""+MultiArray["Next"][lang]+" &gt;&gt;\" onClick=\"addCList_next('<% out.write(newCList_step); %>')\">");</script>
							<script>document.write("<input name=\"finishedInfo\" type=\"button\" value=\""+MultiArray["Finished"][lang]+"\" onClick=\"addCList_finished()\" >");</script>						
								...
								<table>
									<tr>
										...
										<td height="33" valign="top">
											<fieldset><legend><script>document.write(MultiArray["Skip"][lang]);</script></legend><script>document.write(MultiArray["Row(s)"][lang]);</script>&nbsp;
											<input name="rows_to_skip" type="text" size="3" value="0" style="text-align:right; height:15px; font-family:Verdana; font-size:10px " />
											<br>
											</fieldset>									  </td>

										<td valign="top">
											<fieldset><legend><script>document.write(MultiArray["Actions"][lang]);</script></legend>
													
 												<script>document.write("<input type=\"button\" value=\""+MultiArray["Auto fill"][lang]+"\" onClick=\"autoFillsColumns()\">");</script>
												<script>document.write("<input type=\"button\" value=\""+MultiArray["Clear all"][lang]+"\" onClick=\"clearAllAssociations()\">");</script>
											</fieldset>										</td>
										<td valign="top">
											<fieldset><legend><script>document.write(MultiArray["Extras"][lang]);</script></legend>
													<input name="createFieldsFromFirstLine" type="checkbox" value="true" onClick="createNewFieldsFromFistLine(this.checked)"><script>document.write(MultiArray["Create new fields from first line"][lang]);</script>
											</fieldset>										</td>
									</tr>
								</table>
							</td>
											...
											if(table_name.compareTo("") != 0)
											{
												...
												try
												{
													...
													else
													{
														...
														{															
															Manager.ressources.beanLoadCallingList.tableField thisField = (Manager.ressources.beanLoadCallingList.tableField) beanCList.tableFields.elementAt(i);
															out.write("tmpTableField = new tableField();");
														...
														{
															Manager.ressources.beanLoadCallingList.assocField thisassoc = (Manager.ressources.beanLoadCallingList.assocField) beanCList.assocVector.elementAt(i);
							...
							<td valign="top" width="70%"> <!-- LIST OF FILE COLUMNS -->
								...
								<%
									...
									else if(file_extension.compareTo("xls") == 0) // This is an xls file
									{
										...
										{
											out.write("<tr><td><div style=\"color:red\"><script>document.write(MultiArray[\"Warning: No sheet found in this xls file\"][lang]);</script></div></td></tr>");
										}
				...
				else if(newCList_step.compareTo("4") == 0) //Show insertion stats...
				{
					...
					%>
						...
						<table align="center" width="50%" cellpadding="2" cellspacing="2" style="background-color:ThreeDFace; border:3px solid #666666">
							...
							<tr>
								<td><b><script>document.write(MultiArray["Loading statistics"][lang]);</script></b></td>								
							</tr>
							<tr>
								<td width="50%" align="center"><b><script>document.write(MultiArray["Status"][lang]);</script></b></td>
								<td width="50%" align="center"><b><script>document.write(MultiArray["Processed"][lang]);</script></b></td>
							</tr>
							<tr>
							...
							<tr>
								<td width="50%" align="center"><b><script>document.write(MultiArray["Inserted"][lang]);</script></b></td>
								<td width="50%" align="center"><b><script>document.write(MultiArray["Errors"][lang]);</script></b></td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2" align="center"><b><script>document.write(MultiArray["Time"][lang]);</script></b></td>
							</tr>
							<tr>
						...
						<table align="center" width="50%" cellpadding="2" cellspacing="2">
							<tr>
								<td width="100%" align="center">
									<script>document.write("<input id=\"insertPauseButton\" style=\"width:100px\"  type=\"button\" value=\""+MultiArray["Pause"][lang]+"\" onClick=\"if(loadingCurrentStatus == 'Paused') changeLoaderStatus('Inserting...'); else changeLoaderStatus('Paused');\">");</script>																						
									&nbsp;&nbsp;
										<script>document.write("<input id=\"insertStopButton\" style=\"width:100px\"  type=\"button\" value=\""+MultiArray["Stop"][lang]+"\" onClick=\"changeLoaderStatus('Stopped')\">");</script><br>																
										<script>document.write("<input id=\"insertLogErrorButton\" style=\"width:100px; visibility:hidden\"  type=\"button\" value=\""+MultiArray["Show errors"][lang]+"\" onClick=\"askForLogErrorDisplay()\">");</script>																						
						...
						<table>
							<tr>
								<td>
								<script>document.write("<input disabled name=\"nextInfo\"  type=\"button\" value=\""+MultiArray["Next"][lang]+" &gt;&gt;\" onClick=\"addCList_next('<% out.write(newCList_step); %>')\">");</script>															
					...
					<table width="100%">
						<tr>
							<td width="50%" valign="top">
								<fieldset style="border:#999999 solid 1px">
									<legend style="color:#000000"><script>document.write(MultiArray["Dialing hours"][lang]);</script></legend>
									<table>
										<tr><td>&nbsp;</td><td>
											<script>document.write(MultiArray["Close"][lang]);</script> &nbsp; 
											<select name="dialing_from">
												<%										
												for(int i = 0 ; i <= 24; i++)
												{
										...
										<tr><td valign="top"><i><script>document.write(MultiArray["Apply to"][lang]);</script></i></td><td valign="top">
											<input type="radio" name="hoursapplyto" value="all_records" /> <script>document.write(MultiArray["All records"][lang]);</script><br>
											<input type="radio" name="hoursapplyto" value="empty_records" /><script>document.write(MultiArray["Empty hours records"][lang]);</script><br>
											<input type="radio" name="hoursapplyto" value="none" /> <script>document.write(MultiArray["None"][lang]);</script><br>
										</td></tr>
									</table>
								</fieldset>							</td>
							<td width="50%">
								<fieldset style="border:#999999 solid 1px">
									<legend style="color:#000000"><script>document.write(MultiArray["Screen pop"][lang]);</script></legend>
									<table>
										<tr>
											<td><script>document.write(MultiArray["Url"][lang]);</script></td><td>
												<input type="text" name="cList_extrada" style="width:300px" />
											</td>
										</tr>
										<tr>
											<td valign="top"><!--<a href="#" onClick="javascript:adviceUrls()">--><i><script>document.write(MultiArray["Defined urls"][lang]);</script></i><!--</a>--></td><td>
										...
										<tr><td valign="top"><i><script>document.write(MultiArray["Apply to"][lang]);</script></i></td> 
										<td valign="top">
											<input type="radio" name="extradataapplyto" value="all_records" /> <script>document.write(MultiArray["All records"][lang]);</script><br>
											<input type="radio" name="extradataapplyto" value="empty_records" /> <script>document.write(MultiArray["Records with no extradata"][lang]);</script><br>
										<input type="radio" name="extradataapplyto" value="none" /><script>document.write(MultiArray["None"][lang]);</script><br>										</td></tr>
						...
						<tr>
							<td width="100%" colspan="2">
								<fieldset style="border:#999999 solid 1px">
									<legend style="color:#000000"><script>document.write(MultiArray["Phone number purification"][lang]);</script></legend>
									<table>
										<tr>
											<td>&nbsp;</td>
											<td><i><script>document.write(MultiArray["Action"][lang]);</script></i></td>
										</tr>
										<tr>
											<td><i><script>document.write(MultiArray["Non numeric phone numbers"][lang]);</script></i></td>
											<td>
												<input type="radio" name="phone_purification_non_numeric" value="None" /> <script>document.write(MultiArray["None"][lang]);</script> &nbsp;&nbsp;
												<!--<input type="radio" name="phone_purification_non_numeric" value="Remove_non_numeric" /> Remove non numeric caracters &nbsp;&nbsp;-->
												<input type="radio" name="phone_purification_non_numeric" value="Delete_record" /><script>document.write(MultiArray["Remove record"][lang]);</script>&nbsp;&nbsp;											</td>
										</tr>
										<tr>
											<td valign="top">
												<i><script>document.write(MultiArray["Prefix rules"][lang]);</script><br>
										...
										<!--
										<tr>
											<td valign="top"><i>Apply Black list rules<br>
													[<a href="#" onClick="showBlackListRules()" style="font-size:10px">Edit rules</a>]</i></td>
											<td valign="top">
												<input type="radio" name="phone_purification_blackListRules" value="Yes" /> Yes &nbsp;&nbsp;
												<input type="radio" name="phone_purification_blackListRules" value="No" /> No &nbsp;&nbsp;
											</td>
										</tr>
										-->
									</table>
						...
						<tr>
							<td width="100%" colspan="2">
								<fieldset style="border:#999999 solid 1px">
									<legend style="color:#000000"><script>document.write(MultiArray["Time zones setup"][lang]);</script></legend>
									<i><!--[<a href="#" onClick="showTimeZoneRules()" style="font-size:10px">Edit rules</a>]--></i><br>
									<!-- -->
										<table width="100%">
											<tr>
												<td width="45%" valign="top"><script>document.write(MultiArray["Available rules"][lang]);</script><br>												</td>
												<td width="10%">&nbsp;</td>
											  <td width="45%" valign="top"><script>document.write(MultiArray["Selected rules"][lang]);</script><br>
											...
											<tr>
												<td width="45%" valign="top">													
													<select name="timezone_availablerules" size="5">
														<%
															//go and get all existing rules groupname...
												...
												<td width="45%" valign="top">
													<select name="timezone_selectedrules" size="5">
													</select>												</td>
											</tr>
											<tr>
												<td colspan="3">
													<script>document.write(MultiArray["Apply to"][lang]);</script>: 
														<input type="radio" name="timeZoneRulesApplyto" value="all_records" /> <script>document.write(MultiArray["All records"][lang]);</script>&nbsp;&nbsp;
														<input type="radio" name="timeZoneRulesApplyto" value="empty_records"><script>document.write(MultiArray["Empty time zone records"][lang]);</script> &nbsp;&nbsp;
														<input type="radio" name="timeZoneRulesApplyto" value="none"> <script>document.write(MultiArray["None"][lang]);</script>&nbsp;&nbsp;												</td>
											</tr>
										</table>
									<!-- -->
								</fieldset>							</td>
				...
				<%
						...
						if(beanCList.inLoadFormatMode == true)
						{
							...
							out.write("checkOptioninradio( document.callingList.phone_purification_blackListRules , '"+beanCList.phone_purification_blackListRules+"');");
				...
				%>
					<script>sqlInsertionStart = currentTimestamp();</script>
						<table align="center" width="50%" cellpadding="2" cellspacing="2" style="background-color:ThreeDFace; border:3px solid #666666">
							...
							<tr>
								<td><b><script>document.write(MultiArray["Queries status"][lang]);</script></b></td>								
							</tr>
							<tr>
								<td align="center"><b><script>document.write(MultiArray["Actions"][lang]);</script></b></td>
								<td align="center"><b><script>document.write(MultiArray["Status"][lang]);</script></b></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td style="border:1px solid #000000" align="left" id="afterQueries_DailyHours"><script>document.write(MultiArray["Daily hours"][lang]);</script></td>
							...
							<tr>
								<td style="border:1px solid #000000" align="left" id="afterQueries_ExtraData"><script>document.write(MultiArray["Extra data"][lang]);</script></td>
							...
							<tr>
								<td style="border:1px solid #000000" align="left" id="afterQueries_NonNumeric"><script>document.write(MultiArray["Non numeric phone numbers"][lang]);</script></td>
							...
							<tr>
								<td style="border:1px solid #000000" align="left" id="afterQueries_PrefixRules"><script>document.write(MultiArray["Prefix rules"][lang]);</script></td>
							...
							-->
							<tr>
								<td style="border:1px solid #000000" align="left" id="afterQueries_TimeZones"><script>document.write(MultiArray["Time zones"][lang]);</script></td>
				...
				else if(newCList_step.compareTo("7") == 0) //last Panel and save format
				{
					...
					<table align="center" width="50%" cellpadding="2" cellspacing="2" style="background-color:ThreeDFace; border:3px solid #666666">
							...
							<tr>
								<td><b><script>document.write(MultiArray["Diagnostic"][lang]);</script></b></td>
								<td>&nbsp;</td>								
							</tr>
							<tr>
								<td>&nbsp;</td>
							...
							<tr>
								<td><script>document.write(MultiArray["Loaded records"][lang]);</script></td>
								<td align="right">&nbsp;<%=beanCList.getTotalLoadedRecord() %></td>
							</tr>
							<tr>
								<td><script>document.write(MultiArray["Records in table"][lang]);</script></td>
								<td align="right">&nbsp;<%=beanCList.getTotalRecordsInTable() %></td>
							</tr>
							<tr>
								<td><script>document.write(MultiArray["Records with no time zone"][lang]);</script></td>
								<td align="right">&nbsp;<%=beanCList.getTotalRecordsNoTimeZoneInTable() %></td>
							</tr>
							<tr>
								<td><script>document.write(MultiArray["Records with no extra data"][lang]);</script></td>
					...
					out.write("<tr><td align=\"center\" bgcolor=\"#CCCCCC\"><b><script>document.write(MultiArray[\"Save load list settings (Optional)\"][lang]);</script></b></td></tr>");
					out.write("<tr><td><i><script>document.write(MultiArray[\"Setting name\"][lang]);</script></i></td></tr>");
					out.write("<tr><td><input style=\"width:200px\" type=\"text\" name=\"saving_format_name\"></td></tr>");
					out.write("<tr><td><i><script>document.write(MultiArray[\"Existing formats\"][lang]);</script></i></td></tr>");
					...
					<table>
							<tr>
								<td>									
									...
									<script>document.write("<input  name=\"nextInfo\"  type=\"button\" value=\""+MultiArray["Finished"][lang]+" \" onClick=\"addCList_finished()\">");</script>
