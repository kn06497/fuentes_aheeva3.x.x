...
<%
	...
	String userRightsQuery = "SELECT ALLOW_USER_MANAGEMENT, ALLOW_CALLING_LIST_MANAGEMENT FROM cfg_user WHERE DBID='"+currentUserDbid+"'";
...
public String buildChart(String legend_label)
{
	...
	retString.append("<PARAM name=\"legendtitle\"      value=\"Dials\">");
			...
			<fieldset>
				...
				<table>
					...
					<tr>						
						...
						<td><select name="max_attempts" onChange="enabledUpdateButton()">
						...
						<td align="right"><strong><script>document.write(MultiArray["Active"][lang]);</script></strong> 
							<input type="checkbox" name="state" value="ON" onClick="enabledUpdateButton()" checked>
						</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td colspan="2">
							<script>document.write("<input disabled name=\"updateInfo\" type=\"button\" value=\""+MultiArray["Update"][lang]+"\" onClick=\"saveCallingList()\">");</script>
	...
	<div class="tab-page" id="tabPage2">
		...
		<table width="95%">
			<tr>
				...
				&nbsp;<input name="RemoveFilterButton" onClick="removeAssociatedFilter()" type="button" class="grayBut01" value="--">					
				</td>
				<td align="right"></td>
			</tr>
			<tr>
	...
	<div class="tab-page" id="tabPage3">
		...
		<% 
			...
			if(list_name.compareTo("") != 0 && tenant_dbid.compareTo("") != 0)
			{
				...
				//out.write("getTableQuery="+getTableQuery);
				...
				{            
					...
					java.sql.ResultSet rs = stat.executeQuery(getTableNameQuery);
					if(rs.next())
					{					
					...
					String sql_record = "";
					out.write("<table width=\"95%%\" align=\"center\"><tr><td align=\"center\" width=\"50%\">");
					if(table_name.compareTo("") != 0)
					{
						...
						out.write("<applet code=\"Manager.PieChart.PiechartApplet.class\" archive=\"../sAheevaChart.jar\" width=\"275\" height=\"160\" mayscript name=\"graphApplet\">");
		//				out.write( buildChart("Per record status") );						
											
						if(lang.compareTo("0") == 0)
						out.write( buildChart("Per record status") );
				    	else if(lang.compareTo("1") == 0)
						out.write( buildChart("Par état d&#39;enregistrement") );
					    else if(lang.compareTo("2") == 0)
						out.write( buildChart("Por estado de registro") );
						...
						{
							nbColonnes++;
							tmp1 	+= "<PARAM name=\"pie"+pos+"label"+nbColonnes+"\" value=\""+rs_clStats.getString("COL_LABEL")+"\">";
						...
						buildChartString += "<PARAM name=\"Pie"+pos+"\" value=\"60,30,125,"+nbColonnes+",5\">";
						...
						out.write("<applet code=\"Manager.PieChart.PiechartApplet.class\" archive=\"../sAheevaChart.jar\" width=\"275\" height=\"160\" mayscript name=\"graphApplet\">");
		//				out.write( buildChart("<script>document.write(MultiArray[\"Per call result\"][lang]);</script>") );						
						
						if(lang.compareTo("0") == 0)
						out.write( buildChart("Per call result") );
				    	else if(lang.compareTo("1") == 0)
						out.write( buildChart("Par résultat d&#39;appel") );
					    else if(lang.compareTo("2") == 0)
						out.write( buildChart("Por resultado de llamada") );
					...
					//	out.write( buildChart("<script>document.write(MultiArray[\"Per record type\"][lang]);</script>") );						
						...
						if(lang.compareTo("0") == 0)
						out.write( buildChart("Per record type") );
				    	else if(lang.compareTo("1") == 0)
						out.write( buildChart("Par type d&#39;enregistrement") );
					    else if(lang.compareTo("2") == 0)
						out.write( buildChart("Por tipo de registro") );
			...
			//			out.write( buildChart("<script>document.write(MultiArray[\"Answers per day\"][lang]);</script>") );						
						...
						if(lang.compareTo("0") == 0)
						out.write( buildChart("Answers per day") );
				    	else if(lang.compareTo("1") == 0)
						out.write( buildChart("Réponses par jour") );
					    else if(lang.compareTo("2") == 0)
						out.write( buildChart("Contestas por día") );
