...
<jsp:plugin type="applet" archive="sManager.jar" code="Manager.java.ComApplet.class" name="myApplet" height="0" width="0">
	<jsp:params>
		<jsp:param name="debug" value="0"/>
		<jsp:param name="host" value="<%= (remoteIp.substring(0, 7).compareTo("192.168") == 0 ? "192.168.xxx.xxx" : "xxx.xxx.xxx.xxx")%>"/>
