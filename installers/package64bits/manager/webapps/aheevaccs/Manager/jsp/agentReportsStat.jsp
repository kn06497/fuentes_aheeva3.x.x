...
var test =MultiArray["Generals statistics"][lang];
</script>
...
<table width="75%" cellpadding="0" cellspacing="0" align="center">
			...
			<table width="70%" align="center">
				...
				<tr>
					<td  class="reportsID" width="100%" align="center">
						<b>
							<script>document.write(MultiArray["Generals statistics"][lang])</script> &nbsp;<script>document.write(MultiArray["for"][lang])</script><br><br>
							<%
				...
				<table   <% if(detail.compareTo("1")==0 )  { out.write("width=100%"); out.write("align=left");}
					...
					<tr>
						<td width="100%" align="left"><font style="background-color:#FFC5A8">
							<b><script>document.write(MultiArray["Generals statistics"][lang])</script>				
							</b>
							</font>
						</td>
					</tr>			
	...
	<tr>
		<td width="100%" align="center">
			<table width="100%" <% if(detail.compareTo("1")==0 )  { out.write("align=left");}
				...
				<tr>
					...
					out.write("<applet code='Manager.PieChart.PiechartApplet.class'  archive='../sAheevaChart.jar' width='650' height='300' mayscript name='graphApplet'>");
						// Start Up Parameters -->
						
					out.write("<PARAM name='LOADINGMESSAGE' value='"+pageData.getWord("graphloadingmessage")+"'>");
					...
					out.write("<PARAM name='legendtitle'   value='"+ pageData.getWord("calls") +"'>");
				
					
					//out.write("<PARAM name='legendtitle'      value='Calls'>");
					...
					out.write("<PARAM name='Pie1' value='110,50,175,8,5'>");
					...
					out.write("<PARAM name='segment1'   value='115,152,164|"+ pageData.getWord("inbound") +"'>");				
					
					out.write("<PARAM name='segment2'   value='99,99,156|"+ pageData.getWord("outbound") +"'>");				
					
					out.write("<PARAM name='segment3'   value='185,53,8|"+ pageData.getWord("wrapup") +"'>");
					
					out.write("<PARAM name='segment4'   value='239,214,115|"+ pageData.getWord("hold") +"'>");
									
					out.write("<PARAM name='segment5'   value='100,100,60|"+ pageData.getWord("waiting") +"'>");
													
					out.write("<PARAM name='segment6'   value='17,97,158|"+ pageData.getWord("notready") +"'>");
										
					out.write("<PARAM name='segment7'   value='17,97,0|"+ pageData.getWord("singletransfer") +"'>");
		
					out.write("<PARAM name='segment8'   value='180,0,230|"+ pageData.getWord("twosteptransfer") +"'>");
	...
	<tr>
		<td width="100%" align="center">
			<table width="70%" align="center">
				...
				<tr>
					<td  class="reportsID" width="100%" align="center">
						<b><script>document.write(MultiArray["Other statistics"][lang])</script> </b>
					</td>
				</tr>			
			</table>
		</td>
		...
		<tr>
			<td width="100%" align="center">
				<table <% if(detail.compareTo("1")==0 )  { out.write("width=100%"); out.write("align=left");}
					...
					<tr>
						<td width="100%" align="left"><font style="background-color:#FFC5A8">
							<b><script>document.write(MultiArray["Other statistics"][lang])</script> 				
							</b>
							</font>
						</td>
					</tr>			
			...
			<table <% if(detail.compareTo("1")==0 )  { out.write("width=100%"); out.write("align=left");}
			  ...
			  <tr><td height="20"></td></tr>
				  <tr >
					...
					<script>document.write(MultiArray["Sheduled time"][lang])</script></td>
				  ...
				  <tr >
					...
					<%
						out.write(agentInfo.getProductivityTime());
					%>	
				  <tr >
					<td class="reportsTabValues" width="35%" style="border-style:solid; border-width:medium">
					<script>document.write(MultiArray["Adherence"][lang])</script></td>
					<td class="reportsTabValues" width="20%" style="border-style:solid; border-width:medium">
					<%
