...
<jsp:useBean id="beanAgentCommission" scope="session" class="Manager.wfm.beanCommissionReport"/>
	  	...
	  	<h4 class="tab"><script>document.write(MultiArray["Commissions"][lang]);</script></h4>
					...
					<tr>
					  ...
					  <input name="agtChoice" type="radio" value="agent" onClick="changeDisabled()" >						</td>
						<td width="34" ></td>
							...
							<td colspan="2" width="222" id="id_reportDate" style="border-top-style: none; border-top-width: 1">
								...
								<b>&nbsp;&nbsp;  <script>document.write(MultiArray["Show agent by ID"][lang]); </script>
								<input type="checkbox" name="viewckbox" onClick="javascript:changeAgentListView(document.agentHours.agtGrp, document.agentHours.objects, this);" ID="Checkbox2"></b>
								</div>
							</td>
			...
			<!--Debut affichage details pour l'objet choisi-->
				...
				<tr>
					...
					<td align="center" width="130"><b><script>document.write(MultiArray["Commission details"][lang]);</script></b></td>
			 	</tr>
			...
			<%
				...
				if(	allDetails.size() >0)
				{
					...
					float tot_agent_hours =0, tot_grp_hours = 0, tot_commission =0;
