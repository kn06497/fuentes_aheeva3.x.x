...
%>
	...
	<tr <% if(i%2 == 0) out.write("class=reportsRowPair");
		...
		<td width="10%"  align="center"><%out.write(agentInfo.buildReadableTime(agentInfo.totalWrapUpInTime));%></td>
		<td width="5%"  align="center"><%out.write(Long.toString(agentInfo.n_Wrap_In_up) );%></td>
		...
		<td width="100%" align="center">
			<table width="70%" align="left" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse ">
			  <tr class="reportsTabName">
				...
				<td width="10%"  align="center"><script>document.write(MultiArray["Handling"][lang])</script></td>
