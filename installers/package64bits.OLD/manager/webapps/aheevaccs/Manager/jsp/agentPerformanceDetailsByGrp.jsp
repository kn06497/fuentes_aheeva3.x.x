...
<p align="center"><font size=4><b><script>document.write(MultiArray["Agent group performance report"][lang])</script>  </b></font><br><br></p>
 
<table width="350" border="0" align="center">
  <tr>
    <td   class="reportsID"><div align="center"><b><script>document.write(MultiArray["Agent group"][lang])</script> &nbsp; <script>document.write(MultiArray["Performance"][lang])</script>
...
<p class="reportsID" align="center"> <b>[<script>document.write(MultiArray["Group"][lang])</script> :<%out.write( agentGroup +"]");%></b></p>
<p class="reportsID"> </p>
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="850" id="AutoNumber1">
  <tr class="reportsTab">
    <td width="200"   align="center"> <b><script>document.write(MultiArray["Agent name"][lang])</script> </b> </td>
    <td width="50"   align="center"> <b> <script>document.write(MultiArray["Agent ID"][lang])</script></b> </td>
