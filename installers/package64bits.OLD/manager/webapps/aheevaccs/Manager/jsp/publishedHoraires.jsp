...
<head>
<title>AheevaCCS - Group Schedule</title>
	...
	lyr=document.createElement("DIV");
 	lyr.id ='s';
        ...
        if (aSunArray[chosen].substring(aSunArray[chosen].length-1, aSunArray[chosen].length) == '1'){
                code+="<td>"+MultiArray["Sunday"][lang]+"&nbsp;<input type='checkbox' name='ab_sunday' value='Sunday' CHECKED></td>";

   }else{
        code+="<td>"+MultiArray["Sunday"][lang]+ "&nbsp;<input type='checkbox' name='ab_sunday' value='Sunday'></td>";

   }

        <%-- if (aMonArray[chosen].substring(12,13)=='1'){ --%>
        if (aMonArray[chosen].substring(aMonArray[chosen].length-1, aMonArray[chosen].length) == '1'){
                code+="<td>"+MultiArray["Monday"][lang]+"&nbsp;<input type='checkbox' name='ab_monday' value='Monday' checked></td>";
        }else{
                code+="<td>"+MultiArray["Monday"][lang]+"&nbsp;<input type='checkbox' name='ab_monday' value='Monday'></td>";

   }

        <%-- if (aTueArray[chosen].substring(12,13)=='1'){ --%>
        if (aTueArray[chosen].substring(aTueArray[chosen].length-1, aTueArray[chosen].length) == '1'){
                  code+="<td>"+MultiArray["Tuesday"][lang]+"&nbsp;<input type='checkbox' name='ab_tuesday' value='Tuesday' checked></td>";
        }else{
                  code+="<td>"+MultiArray["Tuesday"][lang]+"&nbsp;<input type='checkbox' name='ab_tuesday' value='Tuesday'></td>";
        }

        <%-- if (aWedArray[chosen].substring(12,13)=='1'){ --%>
        if (aWedArray[chosen].substring(aWedArray[chosen].length-1, aWedArray[chosen].length) == '1'){
                  code+="<td>"+MultiArray["Wednesday"][lang]+ "&nbsp;<input type='checkbox' name='ab_wednesday' value='Wednesday' checked></td>";
        }else{
                  code+="<td>"+MultiArray["Wednesday"][lang]+ "&nbsp;<input type='checkbox' name='ab_wednesday' value='Wednesday'></td>";
        }

	<%--if (aThuArray[chosen].substring(12,13)=='1'){ --%>
        if (aThuArray[chosen].substring(aThuArray[chosen].length-1, aThuArray[chosen].length) == '1'){
        code+="<td>"+MultiArray["Thursday"][lang]+"&nbsp;<input type='checkbox' name='ab_thursday' value='Thursday' checked></td>";
        }else{
                 code+="<td>"+MultiArray["Thursday"][lang]+"&nbsp;<input type='checkbox' name='ab_thursday' value='Thursday'></td>";
        }

        <%-- if (aFriArray[chosen].substring(12,13)=='1'){ --%>
        if (aFriArray[chosen].substring(aFriArray[chosen].length-1, aFriArray[chosen].length) == '1'){
                 code+="<td>"+MultiArray["Friday"][lang]+ "&nbsp;<input type='checkbox' name='ab_friday' value='Friday' checked></td>";
        }else{
                 code+="<td>"+MultiArray["Friday"][lang]+ "&nbsp;<input type='checkbox' name='ab_friday' value='Friday'></td>";
        }

        <%-- if (aSatArray[chosen].substring(12,13)=='1'){ --%>
        if (aSatArray[chosen].substring(aSatArray[chosen].length-1, aSatArray[chosen].length) == '1'){
        code+="<td>"+MultiArray["Saturday"][lang]+ "&nbsp;<input type='checkbox' name='ab_saturday' value='Saturday' checked></td>";
        }else{
        code+="<td>"+MultiArray["Saturday"][lang]+ "&nbsp;<input type='checkbox' name='ab_saturday' value='Saturday'></td>";
        }
...
function affiche(selectvalue)
{
	...
	var code='';
	code ="<table border='1'><tr bgcolor='#b4cfff'><td>"+MultiArray["Sunday"][lang]+"</td><td>"+MultiArray["Monday"][lang]+"</td><td>"+MultiArray["Tuesday"][lang]+"</td><td>"+MultiArray["Wednesday"][lang]+"</td><td>"+MultiArray["Thursday"][lang]+"</td><td>"+MultiArray["Friday"][lang]+"</td><td>"+MultiArray["Saturday"][lang]+"</td></tr>";
...
function bla(selectvalue)
{
	...
	var code='';
	code ="<table border='1'><tr><td>"+MultiArray["Sunday"][lang]+"</td><td>"+MultiArray["Monday"][lang]+"</td><td>"+MultiArray["Tuesday"][lang]+"</td><td>"+MultiArray["Wednesday"][lang]+"</td><td>"+MultiArray["Thursday"][lang]+"</td><td>"+MultiArray["Friday"][lang]+"</td><td>"+MultiArray["Saturday"][lang]+"</td></tr>";
	code+="<tr><td align='left' bgcolor='#e6eff4'>"+aSunArray[chosen]+"</td><td bgcolor='#b4cfff'>"+aMonArray[chosen]+"</td><td bgcolor='#e6eff4'>"+aTueArray[chosen]+"</td>";
	code+="<td align='left' bgcolor='#b4cfff'>"+aWedArray[chosen]+"</td><td bgcolor='#e6eff4'>"+aThuArray[chosen]+"</td><td bgcolor='#b4cfff'>"+aFriArray[chosen]+"</td>";
	code+="<td bgcolor='#e6eff4'>"+aSatArray[chosen]+"</td></tr></table>";
...
function addBreak()
{
    ...
    if (maxrow == 1)
	{
    	code ="<table><tr><td align='left'>"+MultiArray["Start"][lang]+"</td><td align='left'>"+MultiArray["End"][lang]+"</td><td>&nbsp;</td></tr>";
...
document.published.action = '/aheevaccs/servlet/AbServlet?fct=quit&agent='+curSelectedAgt+'&sel=2';
	...
	<div class="tab-page" id="tabPage1"  align="center">
	  ...
	  <fieldset >
		<table width="600"  border="0">
			...
			<tr>
				<td width="550" class="reportsID"><div align="center"><b>
					<script>document.write(MultiArray["Agent group"][lang])</script>:  <%out.write(agentGroupName);%>   </b></div>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
		...
		<span class=clickableSpan  id="spanObj"  oncontextmenu="showAgtMenu(); return false" onclick= "hideAgtMenu()" onMouseMove="hideAgtMenuItems()">
		<!--<span class=clickableSpan style="position:absolute" oncontextmenu="showmenuie5(); return false" oncontextmenu = "showAgtMenu(); return false" onclick= "hideAgtMenu()" onMouseMove="hideAgtMenuItems()">-->
...
<td><script>document.write(MultiArray["Total hours"][lang])</script> </td>
		...
		<table>
			 <tr>
			   <td  style="background-color:red" width="40"></td><td>&nbsp;</td><td><script>document.write(MultiArray["agent absent this day"][lang])</script>  </td>
			 </tr>
                         <tr>
			   <td  style="background-color:yellow" width="40"></td><td>&nbsp;</td><td><script>document.write(MultiArray["agent has quit"][lang])</script>  </td>
			 </tr>
		   </table>
	...
	<div class="tab-page" id="tabPage2"  align="center">
	  <h2 class="tab"><script>document.write(MultiArray["Absence"][lang])</script> </h2>
 ...
 <tr>
    <td width="550" class="reportsID">
     <div align="center">
       <b><script>document.write(MultiArray["Absence management for group"][lang])</script> <br><%out.write(agentGroupName);%><br>
        <script>document.write(MultiArray["From"][lang])</script>  <%out.write(startingDateDaily);%> <script>document.write(MultiArray["To"][lang])</script>  <%out.write(endingDateDaily);%></b>
     </div>
    </td>
  </tr>
  <tr>
  ...
  <tr>
   <td>&nbsp;</td>
		...
		<table border=0 align="left">
		   <tr>
			<td align="left"><script>document.write(MultiArray["Choose agent"][lang])</script> </td>
			<td align="left">
		...
		<!--Fin commentaire -->
		   <tr>
			<td align="left"><script>document.write(MultiArray["Schedule"][lang])</script> </td>
			<td align="left">
		   ...
		   <tr>
			<td align="left">
			<script>document.write("<input name=\"submitButton\" type=\"submit\" value=\""+MultiArray["Save"][lang]+"\" onClick=\"return setAbsent();\">")</script>
			<td>&nbsp;</td>
		   </tr>
		  </table>
	  </fieldset>
	...
	<div class="tab-page" id="tabPage3"  align="center">
	  <h2 class="tab"><script>document.write(MultiArray["Shift trade"][lang])</script> </h2>
	   <script type="text/javascript">tp1.addTabPage( document.getElementById( "tabPage3" ) ); </script>
		 ...
		 <tr>
			<td width="550" class="reportsID"><div align="center">
				<b>
				<script>document.write(MultiArray["Shift trade management for group"][lang])</script> <br><%out.write(agentGroupName);%>
				</b></div>
			</td>
		  </tr>
		  <tr>
		...
		<table border=0 align="left">
		   <tr>
				<td align="left"><script>document.write(MultiArray["Choose agent"][lang])</script> 1</td>
			<td align="left">
			...
			<td>&nbsp;</td>
			<td align="left"><script>document.write(MultiArray["Choose day"][lang])</script> </td>
			...
			<td align="left"><script>document.write(MultiArray["Schedule"][lang])</script> </td>
			<td align="left">
			 <div id="agent_shifts1" style="MARGIN: 0px 5px">
			 </div>
			</td>
		   </tr>
			<tr>
			...
			<tr><td align="left"><script>document.write(MultiArray["Choose agent"][lang])</script> 2</td>
			   <td align="left">
				...
				<td align="left"><script>document.write(MultiArray["Schedule"][lang])</script></td>
				<td align="left">
				 <div id="agent_shifts2" style="MARGIN: 0px 5px">  </div>
				</td>
			</tr>
			<tr>
				<td>
				<script>document.write("<input name=\"submitButton\" type=\"submit\" value=\""+MultiArray["Trade"][lang]+"\" onClick=\"return trade();\">")</script>
				</td>
			</tr>
		  </table>
		</fieldset>
	...
	<div class="tab-page" id="tabPage4" >
	  <h2 class="tab"><script>document.write(MultiArray["Manual schedule"][lang])</script> </h2>
	   <script type="text/javascript">tp1.addTabPage( document.getElementById( "tabPage4" ) );</script>
		<%@page import="java.text.SimpleDateFormat"%>
		<%@page import="java.util.Date"%>
		<%@page import="Manager.schedule.*"%>
 		<jsp:useBean id="beanSched" scope="request" class="Manager.schedule.beanAgentSchedule" />
		...
		<div id='paramsDiv'  class="paramsDiv" align="left">
		<legend><script>document.write(MultiArray["View schedule parameters"][lang])</script> </legend>
		<table border="1px" bordercolordark="#ffffff" ><tr>
		 <td  bordercolor="#000000">
			...
			<tr>
				<td height="10" colspan="2" width="200"  ><a style="font-family:Tahoma; font-size:12px; font-weight:bold; color:#000000"><script>document.write(MultiArray["Select an agent"][lang])</script>  </a></td>
				<td width="150" >
			...
			<tr>
				<td colspan="2" rowspan="2"><a style="font-family:Tahoma; font-size:12px; color:#000000; font-weight:bold"><script>document.write(MultiArray["Week selector"][lang])</script>   </a></td>
				<td height="10" ><input type="text" name="WeeklyDateStart" id="WeeklyDateStart"></td>
				<td >&nbsp;</td>
				<td >&nbsp;</td>
				<td  align="right">
					<a style="font-family:Verdana, Arial; font-size:12px; font-weight:bold; color:#000000;"><script>document.write(MultiArray["Starting time"][lang])</script> </a></td>
				<td  align="right">&nbsp;</td>
				<td  align="right" ><a style="font-family:Verdana, Arial; font-size:12px; font-weight:bold;color:#000000;"><script>document.write(MultiArray["Ending time"][lang])</script>  </a></td>
			</tr>
			...
			<tr>
				<td colspan="2"   > <a style="font-family:Tahoma; font-size:12px; font-weight:bold; color:#000000;"><script>document.write(MultiArray["Spacing(mn)"][lang])</script> </a></td>
				<td >
				...
				<script>document.write("<input name=\"viewSched\" type=\"button\" value=\""+MultiArray["View schedule"][lang]+"\" onClick=\"viewScheduleTable()\">")</script>
			
				 </div></td>
				<td  valign"top"  align="right" >&nbsp;<input type="hidden" id="allsched" name="allsched" ></td>
				<td  valign"top"  align="right" >
			<script>document.write("<input id=\"saveSched\" name=\"saveSched\" type=\"button\" value=\""+MultiArray["Save schedule"][lang]+"\" onClick=\"saveScheduleForWeek()\">")</script></td>

			</tr>
			</table>
		 </td>
		 <td rowspan="5"><table><tr><td bgcolor="#0066FF" width="10px"></td><td><a class="legendText"><script>document.write(MultiArray["Work manual"][lang])</script> </a></td></tr>
		 						<tr><td bgcolor="#009900"></td><td><a class="legendText"><script>document.write(MultiArray["Break manual"][lang])</script> </a></td></tr>
								<tr><td bgcolor="#663399"></td><td><a class="legendText"><script>document.write(MultiArray["Work schedule"][lang])</script> </a></td></tr>
								<tr><td bgcolor="#666666"></td><td><a class="legendText"><script>document.write(MultiArray["Break schedule"][lang])</script> </a></td></tr>
								<tr><td bgcolor="#FFFF00"></td><td><a class="legendText"><script>document.write(MultiArray["Cell selection"][lang])</script> </a></tr>
						</table> </td>
		</tr></table>
		</div>
