...
<jsp:useBean id="beanReport" scope="request" class="Manager.reports.beanCampaignReport" />
...
<p align="center">&nbsp; </p>
  <fieldset > <legend class="genericTitle"> <h5><script>document.write(MultiArray["Agent group report"][lang])</script></h5></legend>
...
<div class="reportLook" > 
  ...
  <table border="2"  cellpadding="0" cellspacing="1" style="border-collapse:separate; border-color:#DCDAD6"  width="800" id="AutoNumber1">
    <tr class="reportsTab"> 
      <td width="150"  height="25" align="center"> <script>document.write(MultiArray["Agent group"][lang])</script> 
      </td>
      <td align="center"> <script>document.write(MultiArray["Training hours"][lang])</script> 
      </td>
      <td align="center"><script>document.write(MultiArray["Integration hours"][lang])</script> 
      </td>
      <td align="center"><script>document.write(MultiArray["Production hours"][lang])</script> 
      </td>
      <td align="center"> <script>document.write(MultiArray["Continuing training hours"][lang])</script> 
      </td>
    </tr>
    <%
