...
var save_current_custom_role_html 	= '&nbsp;&nbsp;<input type="text" value="" name="new_role_name">&nbsp;&nbsp;<input type="button" value="Save" onClick="save_new_role()">';
var delete_current_role_html 		= '&nbsp;&nbsp;<a href="#" onclick="javascript:deleteSelectedRole()">Remove this role</a>&nbsp;&nbsp;';
